# vSIGMA API-Enriched Fixture Results Refresh - 2026-08-12
...
## Result Rows
- Kairat Almaty vs Levski Sofia | status=FT | score=0-1 | ready=YES | provider=API-SPORTS_DIRECT | note=fixture fetched
