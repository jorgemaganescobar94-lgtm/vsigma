# vSIGMA Daily Competition Master Report - 2026-08-25
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1610924 | Lask Linz | Celtic | OVER_2_5 | DEEP_ANALYSIS_CANDIDATES | 1.6 |  |  |  | CLV_UNAVAILABLE |  |  |
| 1610924 | Lask Linz | Celtic | OVER_2_5 | OFFICIAL_BASELINE | 1.6 |  |  |  | CLV_UNAVAILABLE |  |  |
...
- No-bet records: 7
- Ledger report: /home/runner/work/vsigma/vsigma/data/processed/today/2026-08-25/vsigma_ledger_daily_report.md

## Daily Controller Status
- Next recommended action: NO_BET_DAY
- Pre-lock due time: NOT_AVAILABLE
- Status path: /home/runner/work/vsigma/vsigma/data/processed/today/2026-08-25/daily_controller_status.md
...
- Critical warnings: official_baseline_output: WARNING - only stale rows found for 2026-08-18
- Recovery command: `.\.venv\Scripts\python.exe scripts\run_daily_competition_controller.py --date 2026-08-24 --timezone Atlantic/Canary --mode pre`
...
- Governance dashboard: /home/runner/work/vsigma/vsigma/data/processed/today/2026-08-25/vsigma_governance_dashboard.md
...
| OVER_1_5 | LOW_CONVERSION | CANDIDATE_V4_O25_FIREWALL | 10 | 9.9 |  | WATCH_PATTERN |
...
| snapshot_contains_expected_file | vsigma_today_competition_top.csv | PASS | /home/runner/work/vsigma/vsigma/data/processed/today/2026-08-25/vsigma_today_competition_top.csv |
| snapshot_contains_expected_file | vsigma_today_candidate_v2_competition_top.csv | PASS | /home/runner/work/vsigma/vsigma/data/processed/today/2026-08-25/vsigma_today_candidate_v2_competition_top.csv |
| snapshot_contains_expected_file | vsigma_today_candidate_v4_competition_top.csv | PASS | /home/runner/work/vsigma/vsigma/data/processed/today/2026-08-25/vsigma_today_candidate_v4_competition_top.csv |
| snapshot_contains_expected_file | vsigma_today_candidate_v5_competition_top.csv | PASS | /home/runner/work/vsigma/vsigma/data/processed/today/2026-08-25/vsigma_today_candidate_v5_competition_top.csv |
| snapshot_contains_expected_file | vsigma_today_candidate_v6_competition_top.csv | PASS | /home/runner/work/vsigma/vsigma/data/processed/today/2026-08-25/vsigma_today_candidate_v6_competition_top.csv |
| snapshot_contains_expected_file | vsigma_today_candidate_v7_competition_top.csv | PASS | /home/runner/work/vsigma/vsigma/data/processed/today/2026-08-25/vsigma_today_candidate_v7_competition_top.csv |
