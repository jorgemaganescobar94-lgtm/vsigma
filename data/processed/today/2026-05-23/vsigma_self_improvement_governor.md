# vSIGMA Self-Improvement Governor - 2026-05-23

## Executive Governor Summary
- generated_at: 2026-05-23T08:57:08+01:00
- executive_status: DATA_QUALITY_BLOCKS_MODEL_CHANGE
- decisions: 14
- decision_counts: DATA_QUALITY_FIRST=8; OPERATIONAL_REVIEW_REQUIRED=2; SHADOW_FACTORY_ALLOWED=2; SHADOW_TRACKING_ACTIVE=1; COLLECT_MORE_SAMPLES=1
- source_counts: IMPROVEMENT_PROPOSAL=12; SHADOW_CANDIDATE=1; PROMOTION_GATE=1
- auto_apply: NO
...
- P2 | DATA_QUALITY_FIRST | IMPROVEMENT_PROPOSAL | sample=17 | shadow_allowed=NO | promotion_pr_allowed=NO | next=OPEN_DATA_QUALITY_REVIEW | reason=Evidence quality gap must be resolved before any model/shadow promotion path.
...
- P1 | SHADOW_FACTORY_ALLOWED | IMPROVEMENT_PROPOSAL | sample=9 | shadow_allowed=YES | promotion_pr_allowed=NO | next=CREATE_OR_CONTINUE_SHADOW_CANDIDATE | reason=Pattern has enough proposal evidence to create/continue a shadow-only candidate, not to modify production.
