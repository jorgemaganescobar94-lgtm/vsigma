...
- quarantine_rows: 13
- blocked_rows: 0
- trust_status_counts: TRUSTED_RAW_SOURCE=344; QUARANTINE_REVIEW=13
...
- blocked_rows: 11
- quarantine_rows: 333
- promotion_status_counts: TRUSTED_SOURCE_BUT_NO_SCORED_ROW=333; NOT_TRUSTED_NO_PROMOTION=13; TRUSTED_SOURCE_BUT_NO_DATA_BLOCKED=11
...
- rows_reviewed: 357
- missing_scored_rows: 333
- no_data_blocked_rows: 11
- not_trusted_rows: 13
- promoted_rows: 0
- gap_status_counts: MISSING_SCORED_ROW=333; NOT_TRUSTED_SKIPPED=13; SCORED_ROW_NO_DATA_BLOCKED=11
- next_action: Repair scoring/enrichment for trusted raw candidates; no market discussion until rows are scored and non-blocked.

## Trusted Raw Scoring Queue
- queue_rows: 333
- priority_counts: P1_TRUSTED_MISSING_SCORING=333
- scoring_needed_counts: YES=333
- source_gap_status: MISSING_SCORED_ROW
- next_action: Use this queue as the explicit input list for a future scoring/enrichment repair stage. Do not create picks from queue rows.

## Queue-to-Enrichment Dry Run Planner
- rows_planned: 333
- dry_run_decision_counts: DRY_RUN_ONLY_NO_API_CALLS=333
- risk_label_counts: MEDIUM=333
- priority_counts: P1_TRUSTED_MISSING_SCORING=333
- total_estimated_call_units: 1665
