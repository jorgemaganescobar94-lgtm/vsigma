...
- match_stat_forecasts | status=OK | rows=6 | date=OK | path=data/processed/today/2026-06-21/vsigma_match_stat_forecasts.csv | detail=file has rows and passed basic diagnostic checks
- forecast_market_translator | status=OK | rows=6 | date=OK | path=data/processed/today/2026-06-21/vsigma_forecast_market_translator.csv | detail=file has rows and passed basic diagnostic checks
- daily_execution_board | status=OK | rows=6 | date=OK | path=data/processed/today/2026-06-21/vsigma_daily_execution_board.csv | detail=file has rows and passed basic diagnostic checks
...
- probable_lineup_consensus | status=OK | rows=6 | date=OK | path=data/processed/today/2026-06-21/vsigma_probable_lineup_consensus.csv | detail=file has rows and passed basic diagnostic checks
