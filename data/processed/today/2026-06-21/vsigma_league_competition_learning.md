# vSIGMA League / Competition Learning - 2026-06-21
...
## Competition Rows
- DIAGNOSTIC|DIAGNOSTIC_NO_COMPETITION | real=0/3 | green=0 red=0 void=0 | no_bet=3 | top_family=NO_MARKET | gate=INSUFFICIENT_SAMPLE | volatility=UNKNOWN_VOLATILITY | status=DIAGNOSTIC_ONLY_NO_REAL_SAMPLE | downstream=DIAGNOSTIC_ONLY_NO_SCORING
- UNKNOWN_COUNTRY|UNKNOWN_LEAGUE | real=0/20 | green=0 red=0 void=0 | no_bet=19 | top_family=UNKNOWN_FAMILY | gate=INSUFFICIENT_SAMPLE | volatility=UNKNOWN_VOLATILITY | status=HOLD_NO_REAL_SAMPLE | downstream=COVERAGE_GATE_ONLY
