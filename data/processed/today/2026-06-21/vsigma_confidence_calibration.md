# vSIGMA Confidence Calibration - 2026-06-21
...
## Confidence Rows
- NO_CONFIDENCE | expected=NA | real=0/10 | green=0 red=0 void=0 | observed=NA | gap=NA | gate=INSUFFICIENT_SAMPLE | status=HOLD_SAMPLE | signal=NO_CONFIDENCE_SIGNAL
