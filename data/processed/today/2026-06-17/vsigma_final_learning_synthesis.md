# vSIGMA Final Learning Synthesis - 2026-06-17
...
- lineup_shock_learning | rows=9 | diag=1 manual=5 sample_blocked=0 pos=0 neg=0 | status=MANUAL_REVIEW_REQUIRED | permission=MANUAL_REVIEW_ONLY
- goal_timing_learning | rows=9 | diag=1 manual=0 sample_blocked=0 pos=0 neg=0 | status=NO_MODEL_CHANGE | permission=NO_MODEL_CHANGE
- scoreline_neighbor_stress | rows=9 | diag=1 manual=0 sample_blocked=0 pos=0 neg=0 | status=NO_MODEL_CHANGE | permission=NO_MODEL_CHANGE
