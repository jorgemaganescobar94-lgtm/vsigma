...
- dated_scored_matches | status=HAS_ROWS | same_day=2 | real=0 | proxy=0 | bet_like=0 | path=data/processed/today/2026-06-17/matches_vsigma_scored_v3.csv | detail=file has same-day rows
...
- candidate_provenance_ledger | status=HAS_ROWS | same_day=2 | real=0 | proxy=0 | bet_like=0 | path=data/processed/today/2026-06-17/vsigma_candidate_provenance_ledger.csv | detail=file has same-day rows
