# vSIGMA Pick Quality Classification - 2026-06-17
...
## Classification Rows
- PENDING_FINAL_ACTUALS | TransINVEST Vilnius vs FK Trakai | market=NO_CLEAR_STAT_MARKET | outcome=PENDING | error=PENDING | action=WAIT_FOR_POSTMATCH_DATA | manual=NO | note=Waiting for final actuals before classifying quality.
