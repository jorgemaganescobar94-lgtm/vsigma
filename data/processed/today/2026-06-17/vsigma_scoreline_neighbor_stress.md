# vSIGMA Scoreline Neighbor Stress - 2026-06-17

## Summary
- scoreline_rows: 9
- scoreline_data_status_counts: NO_SCORELINE_DATA=9
- scoreline_neighbor_bucket_counts: NO_SCORELINE=9
- scoreline_stress_status_counts: SCORELINE_DATA_MISSING=8; DIAGNOSTIC_NO_SCORELINE_STRESS=1
- scoreline_learning_label_counts: NO_SCORELINE_SIGNAL=8; DIAGNOSTIC_NOT_REAL_FIXTURE=1
- stress_evidence_level_counts: LOW=8; NONE=1
- manual_review_required_counts: NO=9
- auto_apply: NO
