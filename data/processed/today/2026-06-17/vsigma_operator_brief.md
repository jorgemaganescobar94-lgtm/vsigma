...
| Field | Value | Meaning |
|---|---|---|
| Previous | date=2026-06-16; action=UNKNOWN; risk=NONE; final=NO_OPERATOR_ACTION; active=0 | data/processed/governance/vsigma_operator_brief.csv |
| Current | date=2026-06-17; action=BROKEN; risk=HIGH; final=SYSTEM_FIX_REQUIRED; active=0 | current_build |
