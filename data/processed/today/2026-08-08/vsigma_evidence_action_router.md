# vSIGMA Evidence Action Router - 2026-08-08

## Executive Action Routing Summary
- generated_at: 2026-08-08T01:33:21+01:00
...
## Routed Actions
- #1 | PRELOCK_CONTEXT_MISSING | fixture=1556628 | market=HOME_WIN | gate=MANUAL_TIMING_REVIEW | phase=prelock_context_review | command=`.\.venv\Scripts\python.exe scripts\run_daily_competition_controller.py --date 2026-08-08 --timezone Atlantic/Canary --mode prelock --window-minutes 90` | reason=No daily_run_plan row found for this fixture; operator must inspect timing before execution.
