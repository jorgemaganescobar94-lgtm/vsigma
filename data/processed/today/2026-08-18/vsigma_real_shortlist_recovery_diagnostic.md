...
- dated_scored_matches | status=EMPTY | same_day=0 | real=0 | proxy=0 | bet_like=0 | path=data/processed/today/2026-08-18/matches_vsigma_scored_v3.csv | detail=file exists but has no data rows
- today_execution_shortlist | status=MISSING | same_day=0 | real=0 | proxy=0 | bet_like=0 | path=data/processed/today/2026-08-18/vsigma_today_execution_shortlist.csv | detail=file is not present
- today_execution_bets_only | status=MISSING | same_day=0 | real=0 | proxy=0 | bet_like=0 | path=data/processed/today/2026-08-18/vsigma_today_execution_bets_only.csv | detail=file is not present
