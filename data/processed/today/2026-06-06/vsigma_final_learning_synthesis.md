# vSIGMA Final Learning Synthesis - 2026-06-06
...
- lineup_shock_learning | rows=2 | diag=2 manual=0 sample_blocked=0 pos=0 neg=0 | status=DIAGNOSTIC_ONLY | permission=NO_LEARNING_DIAGNOSTIC_ONLY
- goal_timing_learning | rows=2 | diag=2 manual=0 sample_blocked=0 pos=0 neg=0 | status=DIAGNOSTIC_ONLY | permission=NO_LEARNING_DIAGNOSTIC_ONLY
- scoreline_neighbor_stress | rows=2 | diag=2 manual=0 sample_blocked=0 pos=0 neg=0 | status=DIAGNOSTIC_ONLY | permission=NO_LEARNING_DIAGNOSTIC_ONLY
