# vSIGMA System Review - 2026-06-06
...
- Ledger rows total: 169
- Ledger rows for target date: 7
- Decision outcome ledger rows total: 61
- Decision outcome ledger actionable rows: 8
- Decision outcome ledger non-actionable rows: 53
- Decision outcome ledger no bet rows: 33
- Decision outcome ledger expired rows: 21
- Decision outcome ledger waiting rows: 20
- Decision outcome ledger blocked rows: 12
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1548052 | Segunda División | Castellón | Almeria | OVER_2_5 | NO_BET | NO | KICKOFF_ALREADY_PASSED | NO |  |  | EXPIRED |  | KICKOFF_ALREADY_PASSED |  |
...
## Model / Market Review
- markets appearing in current/historical inputs: OVER_1_5: 124; OVER_2_5: 31; BTTS_YES: 3; UNDER_3_5: 3; AWAY_WIN: 2
- failure modes principales: FAILURE_MODE_LOW_CONVERSION: 216; LOW_CONVERSION: 108; FAILURE_MODE_AVALANCHE_RISK: 2
- OVER_1_5: appearances=124; calibration_sample=7; status=needs more sample
