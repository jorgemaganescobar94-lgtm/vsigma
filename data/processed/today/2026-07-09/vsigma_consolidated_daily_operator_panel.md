# vSIGMA Consolidated Daily Operator Panel - 2026-07-09
...
## No Bet
- #1 | NO_BET | ML Vitebsk vs Universitatea Craiova | market=NO_CLEAR_STAT_MARKET | stake=NO_STAKE | permission=NO | conf=LOW | score=-34
- #2 | NO_BET | Petrocub vs Egnatia Rrogozhinë | market=NO_CLEAR_STAT_MARKET | stake=NO_STAKE | permission=NO | conf=LOW | score=-34
- #3 | NO_BET | Zira vs Torpedo Kutaisi | market=NO_CLEAR_STAT_MARKET | stake=NO_STAKE | permission=NO | conf=LOW | score=-34
...
- data/processed/today/2026-07-09/official_lineup_sources.csv: rows=124
- data/processed/today/2026-07-09/vsigma_probable_lineup_consensus.csv: rows=27
- data/processed/governance/official_lineup_sources.csv: rows=124
...
- .vsigma/triggers/daily_chain_self_heal.trigger: date=2026-07-09; reason=normalize_daily_chain_self_heal_date; triggered_at=2026-07-09T11:37:42+01:00
- .vsigma/triggers/daily_decision_chain_v2.trigger: date=2026-07-09; reason=normalize_daily_decision_chain_v2_date; triggered_at=2026-07-09T11:37:42+01:00
- .vsigma/triggers/prelock_official_lineup_recheck.trigger: date=2026-07-09; reason=normalize_prelock_recheck_date; triggered_at=2026-07-09T11:37:42+01:00

## Key Files
- data/processed/today/2026-07-09/vsigma_consolidated_daily_operator_panel.md
- data/processed/today/2026-07-09/vsigma_operator_brief.md
- data/processed/today/2026-07-09/vsigma_daily_execution_board.md
- data/processed/today/2026-07-09/vsigma_prelock_live_recheck.md
- data/processed/today/2026-07-09/vsigma_live_trigger_validator.md
- data/processed/today/2026-07-09/vsigma_automation_health.md
- data/processed/today/2026-07-09/vsigma_probable_lineup_source_reliability_governor.md
...
- trigger_date_counts: 2026-07-09=2
...
- rows_planned: 29
- dry_run_decision_counts: DRY_RUN_ONLY_NO_API_CALLS=29
- risk_label_counts: HIGH_LOW_COVERAGE=16; MEDIUM=12; HIGH_CONTEXT_VOLATILITY=1
- priority_counts: P2_LOW_COVERAGE_SCORING=16; P1_TRUSTED_MISSING_SCORING=13
- total_estimated_call_units: 145
