# vSIGMA Consolidated Daily Operator Panel - 2026-07-03
...
- data/processed/today/2026-07-03/official_lineup_sources.csv: rows=72
- data/processed/today/2026-07-03/probable_lineup_sources_autonomous.csv: rows=2
- data/processed/today/2026-07-03/vsigma_probable_lineup_consensus.csv: rows=2
- data/processed/today/2026-07-03/vsigma_probable_lineup_accuracy_ledger.csv: rows=2; probable_status=IMPORTED=2
- data/processed/today/2026-07-03/vsigma_probable_lineup_extraction_quality_ledger.csv: rows=1
- data/processed/governance/official_lineup_sources.csv: rows=72
- data/processed/governance/probable_lineup_sources_autonomous.csv: rows=2
- data/processed/governance/vsigma_probable_lineup_accuracy_ledger.csv: rows=10; probable_status=UNKNOWN=1; LEARNING_ONLY=1; IMPORTED=8
...
- .vsigma/triggers/daily_chain_self_heal.trigger: date=2026-07-03; reason=normalize_daily_chain_self_heal_date; triggered_at=2026-07-03T11:14:14+01:00
- .vsigma/triggers/daily_decision_chain_v2.trigger: date=2026-07-03; reason=normalize_daily_decision_chain_v2_date; triggered_at=2026-07-03T11:14:14+01:00
- .vsigma/triggers/prelock_official_lineup_recheck.trigger: date=2026-07-03; reason=normalize_prelock_recheck_date; triggered_at=2026-07-03T11:14:14+01:00

## Key Files
- data/processed/today/2026-07-03/vsigma_consolidated_daily_operator_panel.md
- data/processed/today/2026-07-03/vsigma_operator_brief.md
- data/processed/today/2026-07-03/vsigma_daily_execution_board.md
- data/processed/today/2026-07-03/vsigma_prelock_live_recheck.md
- data/processed/today/2026-07-03/vsigma_live_trigger_validator.md
- data/processed/today/2026-07-03/vsigma_automation_health.md
- data/processed/today/2026-07-03/vsigma_probable_lineup_source_reliability_governor.md
...
- trigger_date_counts: 2026-07-03=2
