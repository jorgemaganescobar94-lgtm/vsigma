# vSIGMA Dated Scored Snapshot - 2026-06-18
...
- output_path: data/processed/today/2026-06-18/matches_vsigma_scored_v3.csv
- next_action: Snapshot written for coverage diagnostics only; do not create picks. Repair enrichment/coverage.
- auto_apply: NO
- production_change: NO

## Snapshot Rows
- AC Oulu vs Mariehamn | fixture_id=1495703 | league=Veikkausliiga | priority=NO_DATA_BLOCKED | market_hint=UNDER_OR_TEAM_TOTAL_UNDER_CHECK | data_warning=OK_FULL
