# vSIGMA Lineup Shock Learning - 2026-06-18

## Summary
- lineup_rows: 11
- lineup_data_status_counts: HAS_LINEUP_DATA=8; NO_LINEUP_DATA=3
- lineup_shock_status_counts: OFFICIAL_LINEUP_AVAILABLE_NO_BET_REVIEW=7; LINEUP_DATA_MISSING=2; DIAGNOSTIC_NO_LINEUP_LEARNING=1; OFFICIAL_LINEUP_AVAILABLE_NEUTRAL=1
- lineup_learning_label_counts: NO_BET_LINEUP_REVIEW=7; NO_LINEUP_SIGNAL=2; DIAGNOSTIC_NOT_REAL_FIXTURE=1; LINEUP_CONTEXT_PRESENT=1
- shock_evidence_level_counts: MEDIUM=7; LOW=3; NONE=1
- manual_review_required_counts: YES=7; NO=4
- auto_apply: NO
