# vSIGMA Final Learning Synthesis - 2026-06-18
...
## Layer Rows
- official_pick_ledger | rows=2 | diag=0 manual=0 sample_blocked=0 pos=0 neg=0 | status=PENDING_ONLY | permission=WAIT_FOR_FINAL_DATA
- postmatch_pick_audit | rows=2 | diag=0 manual=0 sample_blocked=0 pos=0 neg=0 | status=PENDING_ONLY | permission=WAIT_FOR_FINAL_DATA
- pick_quality_classification | rows=2 | diag=0 manual=0 sample_blocked=0 pos=0 neg=0 | status=PENDING_ONLY | permission=WAIT_FOR_FINAL_DATA
...
- lineup_shock_learning | rows=11 | diag=1 manual=7 sample_blocked=0 pos=0 neg=0 | status=MANUAL_REVIEW_REQUIRED | permission=MANUAL_REVIEW_ONLY
- goal_timing_learning | rows=11 | diag=1 manual=0 sample_blocked=0 pos=0 neg=0 | status=NO_MODEL_CHANGE | permission=NO_MODEL_CHANGE
- scoreline_neighbor_stress | rows=11 | diag=1 manual=0 sample_blocked=0 pos=0 neg=0 | status=NO_MODEL_CHANGE | permission=NO_MODEL_CHANGE
