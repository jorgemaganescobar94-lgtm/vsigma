...
- Decision outcome ledger rows total: 16
- Decision outcome ledger actionable rows: 3
- Decision outcome ledger non-actionable rows: 13
- Decision outcome ledger no bet rows: 8
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1544652 | Serie B | Sudtirol | Bari | OVER_1_5 | NO_BET | NO | ODDS_NOT_AVAILABLE;LINEUPS_NOT_AVAILABLE;AVAILABILITY_NOT_AVAILABLE | YES | 2026-05-22T18:00+01:00 | ODDS_MISSING;LINEUPS_MISSING;AVAILABILITY_MISSING | DATA_GAP_BLOCKED |  | PRELOCK_NOT_AVAILABLE |  |
| 1494177 | Allsvenskan | Djurgardens IF | IF Brommapojkarna | OVER_2_5 | EXECUTABLE | YES | NONE | NO |  | ODDS_MISSING | PRELOCK_CONFIRMED |  | PRELOCK_CONFIRMED |  |
...
- odds structure depth: target_fixtures: 5; OK: 5; RICH_COHERENT: 4; RICH_MIXED: 1; BROAD_GOALS: 3
...
| P2 | api_data | Target API enrichment to candidate fixtures only | Coverage gaps are present, but broad calendar enrichment would add cost and repo churn. | Improves prelock evidence where it matters without expanding data volume unnecessarily. | Medium; API quotas and cache growth must be controlled. | Fetch lineups only for candidate picks in-window, injuries only for reliable leagues, and fixture statistics only for TOP candidates; keep cache bounds. | YES | data_gap_flags=ODDS_MISSING;LINEUPS_MISSING;AVAILABILITY_MISSING: 1; ODDS_MISSING: 1; prelock_lineup_state=LINEUPS_NOT_AVAILABLE: 1; LINEUPS_CONFIRMED: 1; prelock_odds_state=ODDS_NOT_AVAILABLE: 2; prelock_availability_state=AVAILABILITY_NOT_AVAILABLE: 1; AVAILABILITY_CONFIRMED: 1 |
...
## Input Inventory
- generated_at: 2026-05-22T17:57:54+01:00
