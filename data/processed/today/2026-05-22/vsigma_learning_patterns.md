# vSIGMA Learning Patterns - 2026-05-22

## Executive Pattern Summary
- generated_at: 2026-05-23T12:42:40+01:00
- patterns detected: 12
- pattern_type_counts: MARKET_RISK_CLUSTER=5, SAMPLE_KEY_CLUSTER=4, EXPIRED_PRELOCK_CLUSTER=1, WAITING_PRELOCK_CLUSTER=1, UNRESOLVED_DOMINANCE=1
- severity_counts: P2=8, P1=2, P3=2

## Top Patterns
- P1 | EXPIRED_PRELOCK_CLUSTER | EXPIRED_PRELOCK | n=5 | recommendation=Review AUTO/PRELOCK timing; exclude expired rows from predictive accuracy metrics.
...
- P2 | UNRESOLVED_DOMINANCE | UNRESOLVED_RESULTS | n=19 | recommendation=Improve post-results labeling and wait for closed samples before proposing model changes.
- P2 | MARKET_RISK_CLUSTER | OVER_1_5::UNKNOWN_RISK | n=9 | recommendation=Monitor market/risk concentration; do not adjust model until losses and sample size clear promotion gates.
- P2 | SAMPLE_KEY_CLUSTER | UNRESOLVED::OVER_1_5::UNKNOWN_RISK::NO_SIGNAL | n=9 | recommendation=Keep collecting evidence; repeated sample key can feed improvement proposal only after sufficient closed results.
...
- P2 | MARKET_RISK_CLUSTER | OVER_2_5::FAILURE_MODE_LOW_CONVERSION | n=5 | recommendation=Monitor market/risk concentration; do not adjust model until losses and sample size clear promotion gates.
