...
### #1 Djurgardens IF vs IF Brommapojkarna
- League: Allsvenskan
- Market: OVER_2_5
- Bucket: PREMIUM_CORE
- Recommendation: BET
...
- Bucket: PREMIUM_CORE
- Recommendation: BET
- Execution score: 121.196
- Main why: STRONG_ROLLING_STATS;CLEAN_MARKET_FIT;CORE_GATE_PASSED;EDGE_ABOVE_THRESHOLD;MODEL_PROB_STRONG;BET_EXECUTABLE
- Primary risk: FAILURE_MODE_LOW_CONVERSION; market=OVER_1_5; edge=0.161; market_fit=SAFE_OK
- Bucket rationale: PREMIUM_CORE: CORE_GATE_PASSED; APPROVED_PREMIUM; BET; SAFE_OK
- Rank rationale: EXECUTION_SHORTLIST_SORT: execution_rank=2; phase=PREMIUM_CORE; execution_score=121.196; selection_score=86.110; primary_edge=0.161; primary_model_prob=0.855; shortlist_rank=3; caps=league2_market2_fixture1
- Confirmation layers: STATS+ODDS+MARKET_TRANSLATION+FORM+LEAGUE_COVERAGE

### #3 Rot-Weiß Essen vs SpVgg Greuther Fürth
- League: 2. Bundesliga
- Market: OVER_2_5
- Bucket: PREMIUM_CORE
- Recommendation: BET
...
- xG: home 1.2-1.9; away 1.5-2.2; total 2.9-4.0
- Shots: home 12-16; away 8-12; SOT 4-6 vs 2-4
- Corners / possession: 6-10; home 51-59% / away 41-49%
...
### #2 Djurgardens IF vs IF Brommapojkarna
- Market: OVER_2_5
...
- xG: home 2.3-3.0; away 1.2-1.9; total 3.6-4.7
- Shots: home 13-17; away 10-14; SOT 4-6 vs 3-5
