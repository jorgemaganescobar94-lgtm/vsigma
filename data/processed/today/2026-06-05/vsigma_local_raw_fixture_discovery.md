...
- accepted_rows: 68
- rejected_rows: 240
- source_status_counts: NO_SAME_DAY_ROWS=1079; EMPTY_OR_UNREADABLE=386; NO_ACCEPTED_ROWS=14; HAS_ACCEPTED_ROWS=2
- next_action: Review accepted rows, then feed normal scoring gates.
- auto_apply: NO
- production_change: NO

## Accepted Rows
- Las Palmas vs Malaga | fixture_id=1548053 | league=Segunda División | source=data/processed/governance/vsigma_match_stat_forecasts.csv
- Castellón vs Almeria | fixture_id=1548052 | league=Segunda División | source=data/processed/governance/vsigma_raw_candidate_trust_gate.csv
...
- data/processed/governance/vsigma_api_enriched_scored_candidates.csv | status=NO_ACCEPTED_ROWS | rows=35 | same_day=35 | accepted=0 | rejected=35 | detail=target-date rows exist but are blocked or missing identity
...
- data/processed/governance/vsigma_local_raw_fixture_discovery_candidates.csv | status=NO_ACCEPTED_ROWS | rows=68 | same_day=68 | accepted=0 | rejected=68 | detail=target-date rows exist but are blocked or missing identity
...
- data/processed/governance/vsigma_promoted_api_enriched_candidates.csv | status=NO_ACCEPTED_ROWS | rows=16 | same_day=16 | accepted=0 | rejected=16 | detail=target-date rows exist but are blocked or missing identity
...
- data/processed/governance/vsigma_raw_candidate_trust_gate.csv | status=HAS_ACCEPTED_ROWS | rows=68 | same_day=68 | accepted=67 | rejected=0 | detail=local source contains accepted raw fixture rows
...
- data/processed/governance/vsigma_trusted_raw_candidate_promotion_gate.csv | status=NO_ACCEPTED_ROWS | rows=68 | same_day=68 | accepted=0 | rejected=0 | detail=target-date rows exist but are blocked or missing identity
- data/processed/governance/vsigma_trusted_raw_fixture_candidates.csv | status=NO_ACCEPTED_ROWS | rows=35 | same_day=35 | accepted=0 | rejected=0 | detail=target-date rows exist but are blocked or missing identity
