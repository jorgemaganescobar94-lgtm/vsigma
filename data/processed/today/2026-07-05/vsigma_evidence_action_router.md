# vSIGMA Evidence Action Router - 2026-07-05

## Executive Action Routing Summary
- generated_at: 2026-07-05T02:26:43+01:00
...
## Routed Actions
- #1 | PRELOCK_CONTEXT_MISSING | fixture=1494200 | market=OVER_2_5 | gate=MANUAL_TIMING_REVIEW | phase=prelock_context_review | command=`.\.venv\Scripts\python.exe scripts\run_daily_competition_controller.py --date 2026-07-05 --timezone Atlantic/Canary --mode prelock --window-minutes 90` | reason=No daily_run_plan row found for this fixture; operator must inspect timing before execution.
