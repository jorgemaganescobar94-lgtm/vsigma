...
- accepted_rows: 2
- rejected_rows: 4
- source_status_counts: NO_SAME_DAY_ROWS=1545; EMPTY_OR_UNREADABLE=1103; NO_ACCEPTED_ROWS=4; HAS_ACCEPTED_ROWS=1
...
- data/processed/governance/vsigma_local_raw_fixture_discovery_candidates.csv | status=NO_SAME_DAY_ROWS | rows=443 | same_day=0 | accepted=0 | rejected=0 | detail=file has no target-date rows
...
- data/processed/governance/vsigma_raw_candidate_trust_gate.csv | status=NO_SAME_DAY_ROWS | rows=443 | same_day=0 | accepted=0 | rejected=0 | detail=file has no target-date rows
...
- data/processed/governance/vsigma_trusted_raw_candidate_promotion_gate.csv | status=NO_SAME_DAY_ROWS | rows=443 | same_day=0 | accepted=0 | rejected=0 | detail=file has no target-date rows
- data/processed/governance/vsigma_trusted_raw_fixture_candidates.csv | status=NO_SAME_DAY_ROWS | rows=402 | same_day=0 | accepted=0 | rejected=0 | detail=file has no target-date rows
