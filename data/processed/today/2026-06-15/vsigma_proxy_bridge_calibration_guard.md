# vSIGMA Proxy Bridge Calibration Guard - 2026-06-15
...
## Guard Rows
- Maringá vs Maranhão | action=NO_CHANGE | market_hint=UNDER_OR_TEAM_TOTAL_UNDER_CHECK | before=NO_CLEAR_STAT_MARKET -> after=NO_CLEAR_STAT_MARKET | permission=NO_BET -> NO_BET | reason=not a proxy inversion
