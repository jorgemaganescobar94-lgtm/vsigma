# vSIGMA Healthcheck Report - 2026-08-14

- Global health status: WARNING
- Generated at: 2026-08-14T15:57:41.689795+01:00
- Mode: full
- HEALTHY: 32
- WARNING: 3
- NEEDS_ATTENTION: 0
- BROKEN: 0
- NOT_RUN_YET: 2
- First recovery command: `.\.venv\Scripts\python.exe scripts\update_immutable_daily_ledger.py --date 2026-08-14 --stage PRE`

## Critical Warnings
| check_name | status | detail | recovery_command |
| --- | --- | --- | --- |
| ledger_target_date_rows | WARNING | ledger has no rows for target date | .\.venv\Scripts\python.exe scripts\update_immutable_daily_ledger.py --date 2026-08-14 --stage PRE |
| freshness_report | WARNING | validation report contains warning rows | .\.venv\Scripts\python.exe scripts\validate_daily_output_freshness.py --date 2026-08-14 |
| recent_automation_logs | WARNING | supervisor log directory missing | .\.venv\Scripts\python.exe scripts\run_daily_competition_controller.py --date 2026-08-14 --timezone Atlantic/Canary --mode status |
...
| today_snapshot_folder | HEALTHY | today snapshot folder present | .\.venv\Scripts\python.exe scripts\run_daily_competition_controller.py --date 2026-08-14 --timezone Atlantic/Canary --mode pre | /home/runner/work/vsigma/vsigma/data/processed/today/2026-08-14 |
...
| daily_master_report | HEALTHY | present |  | /home/runner/work/vsigma/vsigma/data/processed/today/2026-08-14/daily_competition_master_report.md |
...
| ledger_target_date_rows | WARNING | ledger has no rows for target date | .\.venv\Scripts\python.exe scripts\update_immutable_daily_ledger.py --date 2026-08-14 --stage PRE | /home/runner/work/vsigma/vsigma/data/processed/ledger/vsigma_immutable_daily_pick_ledger.csv |
...
| freshness_report | WARNING | validation report contains warning rows | .\.venv\Scripts\python.exe scripts\validate_daily_output_freshness.py --date 2026-08-14 | /home/runner/work/vsigma/vsigma/data/processed/vsigma_daily_freshness_report.csv |
...
| recent_automation_logs | WARNING | supervisor log directory missing | .\.venv\Scripts\python.exe scripts\run_daily_competition_controller.py --date 2026-08-14 --timezone Atlantic/Canary --mode status | /home/runner/work/vsigma/vsigma/automation_logs/supervisor |
| disk_space | HEALTHY | free disk space acceptable: 85.92 GB |  |  |
