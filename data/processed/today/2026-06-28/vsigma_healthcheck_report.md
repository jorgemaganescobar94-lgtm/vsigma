...
- Generated at: 2026-06-28T00:10:05.900752+01:00
- Mode: full
- HEALTHY: 31
- WARNING: 4
- NEEDS_ATTENTION: 0
- BROKEN: 0
- NOT_RUN_YET: 2
- First recovery command: `.\.venv\Scripts\python.exe scripts\build_daily_competition_master_report.py --date 2026-06-28`

## Critical Warnings
| check_name | status | detail | recovery_command |
| --- | --- | --- | --- |
| daily_master_report | WARNING | daily master report missing | .\.venv\Scripts\python.exe scripts\build_daily_competition_master_report.py --date 2026-06-28 |
| ledger_target_date_rows | WARNING | ledger has no rows for target date | .\.venv\Scripts\python.exe scripts\update_immutable_daily_ledger.py --date 2026-06-28 --stage PRE |
...
| daily_master_report | WARNING | daily master report missing | .\.venv\Scripts\python.exe scripts\build_daily_competition_master_report.py --date 2026-06-28 | /home/runner/work/vsigma/vsigma/data/processed/today/2026-06-28/daily_competition_master_report.md |
...
| ledger_target_date_rows | WARNING | ledger has no rows for target date | .\.venv\Scripts\python.exe scripts\update_immutable_daily_ledger.py --date 2026-06-28 --stage PRE | /home/runner/work/vsigma/vsigma/data/processed/ledger/vsigma_immutable_daily_pick_ledger.csv |
...
| freshness_report | WARNING | validation report contains warning rows | .\.venv\Scripts\python.exe scripts\validate_daily_output_freshness.py --date 2026-06-28 | /home/runner/work/vsigma/vsigma/data/processed/vsigma_daily_freshness_report.csv |
