# vSIGMA Consolidated Daily Operator Panel - 2026-07-20
...
## No Bet
- #1 | NO_BET | Halmstad vs BK Hacken | market=NO_CLEAR_STAT_MARKET | stake=NO_STAKE | permission=NO | conf=LOW | score=-34
- #2 | NO_BET | FC Anyang vs Gwangju FC | market=NO_CLEAR_STAT_MARKET | stake=NO_STAKE | permission=NO | conf=LOW | score=-34
- #3 | NO_BET | Hammarby FF vs Degerfors IF | market=NO_CLEAR_STAT_MARKET | stake=NO_STAKE | permission=NO | conf=LOW | score=-34
...
- source: data/processed/today/2026-07-20/vsigma_api_enriched_review_board.csv
...
### API Review Rows
- P1_MANUAL_REVIEW | Hammarby FF vs Degerfors IF | status=API_ENRICHED_REVIEW_READY | score=100 | canonical=NO_CANONICAL_BOARD_PERMISSION | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION | summary=prediction_winner=Hammarby FF | pred_total_home_away=70.3/29.7 | 1x2=1.22/5.75/13.00 | ou2.5=1.50/2.60
- P1_MANUAL_REVIEW | Halmstad vs BK Hacken | status=API_ENRICHED_REVIEW_READY | score=100 | canonical=NO_CANONICAL_BOARD_PERMISSION | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION | summary=prediction_winner=BK Hacken | pred_total_home_away=33.7/66.5 | 1x2=5.20/4.33/1.55 | ou2.5=1.50/2.62
- P1_MANUAL_REVIEW | FC Anyang vs Gwangju FC | status=API_ENRICHED_REVIEW_READY | score=100 | canonical=NO_CANONICAL_BOARD_PERMISSION | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION | summary=prediction_winner=FC Anyang | pred_total_home_away=65.8/34.2 | 1x2=1.55/3.75/6.25 | ou2.5=2.00/1.80
...
- data/processed/today/2026-07-20/official_lineup_sources.csv: rows=198
- data/processed/today/2026-07-20/vsigma_probable_lineup_consensus.csv: rows=3
- data/processed/governance/official_lineup_sources.csv: rows=198
...
- .vsigma/triggers/daily_chain_self_heal.trigger: date=2026-07-20; reason=normalize_daily_chain_self_heal_date; triggered_at=2026-07-20T11:25:29+01:00
- .vsigma/triggers/daily_decision_chain_v2.trigger: date=2026-07-20; reason=normalize_daily_decision_chain_v2_date; triggered_at=2026-07-20T11:25:29+01:00
- .vsigma/triggers/prelock_official_lineup_recheck.trigger: date=2026-07-20; reason=normalize_prelock_recheck_date; triggered_at=2026-07-20T11:25:29+01:00

## Key Files
- data/processed/today/2026-07-20/vsigma_consolidated_daily_operator_panel.md
- data/processed/today/2026-07-20/vsigma_operator_brief.md
- data/processed/today/2026-07-20/vsigma_daily_execution_board.md
- data/processed/today/2026-07-20/vsigma_prelock_live_recheck.md
- data/processed/today/2026-07-20/vsigma_live_trigger_validator.md
- data/processed/today/2026-07-20/vsigma_automation_health.md
- data/processed/today/2026-07-20/vsigma_probable_lineup_source_reliability_governor.md
...
- trigger_date_counts: 2026-07-20=2
