...
- data/processed/governance/vsigma_trusted_raw_fixture_candidates.csv | status=NO_ACCEPTED_ROWS | rows=58 | same_day=58 | accepted=0 | rejected=0 | detail=target-date rows exist but are blocked or missing identity
