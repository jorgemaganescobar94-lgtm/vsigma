# vSIGMA Objective Context Execution Bridge - 2026-07-20
...
## Bridge Rows
- #1 | Halmstad vs BK Hacken | market=AWAY_WIN | recommendation=BET | guard=BASE_PROXY_FROM_OBJECTIVE_GATE_HOME
- #2 | Hammarby FF vs Degerfors IF | market=BTTS_YES | recommendation=BET | guard=BASE_PROXY_FROM_OBJECTIVE_GATE_TEMPO
- #3 | FC Anyang vs Gwangju FC | market=HOME_WIN | recommendation=BET | guard=BASE_PROXY_FROM_OBJECTIVE_GATE_AWAY
