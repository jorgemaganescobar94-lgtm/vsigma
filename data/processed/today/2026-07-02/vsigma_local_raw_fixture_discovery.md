...
- accepted_rows: 64
- rejected_rows: 296
- source_status_counts: NO_SAME_DAY_ROWS=1452; EMPTY_OR_UNREADABLE=1078; NO_ACCEPTED_ROWS=14; HAS_ACCEPTED_ROWS=1
...
- data/processed/governance/vsigma_trusted_raw_fixture_candidates.csv | status=NO_ACCEPTED_ROWS | rows=62 | same_day=62 | accepted=0 | rejected=0 | detail=target-date rows exist but are blocked or missing identity
