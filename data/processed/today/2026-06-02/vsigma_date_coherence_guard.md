...
## Component Rows
- daily_board_md | status=MISSING_CORE | observed=MISSING | path=data/processed/today/2026-06-02/vsigma_daily_execution_board.md | detail=required daily artifact is missing
- daily_board_csv | status=MISSING_CORE | observed=MISSING | path=data/processed/today/2026-06-02/vsigma_daily_execution_board.csv | detail=required daily artifact is missing
...
- automation_health_md | status=MISSING_CORE | observed=MISSING | path=data/processed/today/2026-06-02/vsigma_automation_health.md | detail=required daily artifact is missing
...
- consolidated_panel_md | status=MISSING_OPTIONAL | observed=MISSING | path=data/processed/today/2026-06-02/vsigma_consolidated_daily_operator_panel.md | detail=optional artifact not found
- source_reliability_governor_md | status=MISSING_OPTIONAL | observed=MISSING | path=data/processed/today/2026-06-02/vsigma_probable_lineup_source_reliability_governor.md | detail=optional artifact not found
...
- prelock_recheck_trigger | status=DATE_MISMATCH | observed=2026-06-01 | path=.vsigma/triggers/prelock_official_lineup_recheck.trigger | detail=observed 2026-06-01 != target 2026-06-02
