# vSIGMA API-Enriched Manual Review Inspector - 2026-08-10
...
## Inspector Rows
- #1 | Dundee Utd vs Rangers | priority=P2_MANUAL_REVIEW | signal_score=70 | signal_band=MEDIUM_SIGNAL_REVIEW | bucket=P3_REVIEW_LOW_SIGNAL | risk=LOW | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION | reason=Low/medium review signal. Keep as low-priority manual inspection only.
