# vSIGMA Market Family Calibration - 2026-06-04

## Summary
- family_rows: 1
- sample_gate_counts: INSUFFICIENT_SAMPLE=1
- calibration_status_counts: HOLD_SAMPLE=1
- confidence_signal_counts: NO_WEIGHT_CHANGE=1
- auto_apply: NO
- production_change: NO

## Family Rows
- NO_MARKET | real=0/1 | green=0 red=0 void=0 | gate=INSUFFICIENT_SAMPLE | status=HOLD_SAMPLE | signal=NO_WEIGHT_CHANGE | action=Collect more market-family samples before changing confidence.
