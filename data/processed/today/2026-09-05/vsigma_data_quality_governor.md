# vSIGMA Data Quality Governor - 2026-09-05

## Executive Data Quality Summary
- generated_at: 2026-09-05T02:10:14+01:00
...
## Prioritized Issues
- P1 | NO_SIGNAL | n=7 | key=NO_SIGNAL | action=Populate improvement_signal or classify as monitor-only.
- P1 | UNKNOWN_MARKET | n=7 | key=UNKNOWN_MARKET | action=Normalize missing market_primary before pattern mining.
- P1 | UNKNOWN_RISK | n=7 | key=UNKNOWN_RISK | action=Populate accuracy_primary_risk before pattern mining.
- P2 | UNRESOLVED_LEDGER_ROWS | n=7 | key=RESULT_STATUS_UNRESOLVED | action=Run/verify post-result labeling until learning rows close.
