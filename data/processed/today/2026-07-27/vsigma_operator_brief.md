# vSIGMA Daily Operator Brief - 2026-07-27
...
| Field | Value | Meaning |
|---|---|---|
| Previous | date=2026-07-27; action=UNKNOWN; risk=NONE; final=NO_OPERATOR_ACTION; active=0 | data/processed/today/2026-07-27/vsigma_operator_brief.csv |
| Current | date=2026-07-27; action=NONE; risk=NONE; final=NO_OPERATOR_ACTION; active=0 | current_build |
...
- recheck_decisions: CANCELLED_NO_BET=4
- live_triggers: none
...
- WINDOWS_READ=UTF8 | Get-Content data/processed/today/2026-07-27/vsigma_operator_brief.md -Encoding UTF8
...
## No Bet
- #1 | NO_BET | IF Brommapojkarna vs Hammarby FF | market=NO_CLEAR_STAT_MARKET | bucket=BLOCKED | conf=LOW | score=-34 | cancel=default no bet; low forecast confidence; bad or incomplete lineups
- #2 | NO_BET | KFUM Oslo vs Molde | market=NO_CLEAR_STAT_MARKET | bucket=BLOCKED | conf=LOW | score=-34 | cancel=default no bet; low forecast confidence; bad or incomplete lineups
- #3 | NO_BET | Remo vs Vitoria | market=NO_CLEAR_STAT_MARKET | bucket=BLOCKED | conf=LOW | score=-34 | cancel=default no bet; bad or incomplete lineups
- #4 | NO_BET | Aalesund vs Viking | market=NO_CLEAR_STAT_MARKET | bucket=BLOCKED | conf=LOW | score=-34 | cancel=default no bet; bad or incomplete lineups
...
## Key Files
- data/processed/today/2026-07-27/vsigma_daily_execution_board.md
- data/processed/today/2026-07-27/vsigma_prelock_live_recheck.md
- data/processed/today/2026-07-27/vsigma_live_trigger_validator.md
- data/processed/today/2026-07-27/vsigma_automation_health.md
- data/processed/today/2026-07-27/vsigma_issue_alert_status.md
...
### Calibration Sources
- shadow_queue: data/processed/today/2026-07-27/vsigma_calibration_shadow_patch_queue.csv
- promotion_readiness: data/processed/today/2026-07-27/vsigma_shadow_patch_promotion_readiness.csv
