...
- Stale warnings: STALE_PRELOCK_EXCLUDED: 2026-05-25

## Next Operator Command
- Action: NO_BET_DAY
- Command: `.\.venv\Scripts\python.exe scripts\run_daily_competition_controller.py --date 2026-05-26 --timezone Atlantic/Canary --mode status`
