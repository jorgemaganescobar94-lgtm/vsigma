# vSIGMA API-Enriched Fixture Results Refresh - 2026-07-06
...
## Result Rows
- Degerfors IF vs Malmo FF | status=FT | score=0-1 | ready=YES | provider=API-SPORTS_DIRECT | note=fixture fetched
- Jeonbuk Motors vs Gangwon FC | status=FT | score=1-2 | ready=YES | provider=API-SPORTS_DIRECT | note=fixture fetched
