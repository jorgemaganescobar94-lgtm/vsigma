# vSIGMA Consolidated Daily Operator Panel - 2026-07-06
...
## No Bet
- #1 | NO_BET | Degerfors IF vs Malmo FF | market=NO_CLEAR_STAT_MARKET | stake=NO_STAKE | permission=NO | conf=LOW | score=-34
- #2 | NO_BET | Jeonbuk Motors vs Gangwon FC | market=NO_CLEAR_STAT_MARKET | stake=NO_STAKE | permission=NO | conf=LOW | score=-34
...
- source: data/processed/today/2026-07-06/vsigma_api_enriched_review_board.csv
...
### API Review Rows
- P1_MANUAL_REVIEW | Degerfors IF vs Malmo FF | status=API_ENRICHED_REVIEW_READY | score=100 | canonical=NO_CANONICAL_BOARD_PERMISSION | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION | summary=prediction_winner=Malmo FF | pred_total_home_away=34.3/65.7 | 1x2=3.10/3.45/2.20 | ou2.5=1.85/1.95
- P1_MANUAL_REVIEW | Jeonbuk Motors vs Gangwon FC | status=API_ENRICHED_REVIEW_READY | score=81 | canonical=NO_CANONICAL_BOARD_PERMISSION | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION | summary=prediction_winner=Jeonbuk Motors | pred_total_home_away=58.8/41.2 | 1x2=2.25/3.00/3.35 | ou2.5=2.35/1.57
...
- data/processed/today/2026-07-06/official_lineup_sources.csv: rows=88
- data/processed/today/2026-07-06/vsigma_probable_lineup_consensus.csv: rows=2
...
- .vsigma/triggers/daily_chain_self_heal.trigger: date=2026-07-06; reason=normalize_daily_chain_self_heal_date; triggered_at=2026-07-06T12:48:11+01:00
- .vsigma/triggers/daily_decision_chain_v2.trigger: date=2026-07-06; reason=normalize_daily_decision_chain_v2_date; triggered_at=2026-07-06T12:48:11+01:00
- .vsigma/triggers/prelock_official_lineup_recheck.trigger: date=2026-07-06; reason=normalize_prelock_recheck_date; triggered_at=2026-07-06T12:48:11+01:00

## Key Files
- data/processed/today/2026-07-06/vsigma_consolidated_daily_operator_panel.md
- data/processed/today/2026-07-06/vsigma_operator_brief.md
- data/processed/today/2026-07-06/vsigma_daily_execution_board.md
- data/processed/today/2026-07-06/vsigma_prelock_live_recheck.md
- data/processed/today/2026-07-06/vsigma_live_trigger_validator.md
- data/processed/today/2026-07-06/vsigma_automation_health.md
- data/processed/today/2026-07-06/vsigma_probable_lineup_source_reliability_governor.md
...
- trigger_date_counts: 2026-07-06=2
