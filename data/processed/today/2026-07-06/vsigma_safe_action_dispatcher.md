# vSIGMA Safe Action Dispatcher - 2026-07-06

## Executive Dispatcher Summary
- generated_at: 2026-07-06T02:57:39+01:00
...
## Dispatch Queue
- #1 | MANUAL_TIMING_REVIEW_REQUIRED | allowed=NO | fixture=1494194 | market=OVER_2_5 | phase=manual_timing_review | command=`.\.venv\Scripts\python.exe scripts\run_daily_competition_controller.py --date 2026-07-06 --timezone Atlantic/Canary --mode prelock --window-minutes 90` | reason=Daily run plan lacks timing context; operator must inspect before dispatch.
- #2 | MANUAL_TIMING_REVIEW_REQUIRED | allowed=NO | fixture=1506988 | market=OVER_1_5 | phase=manual_timing_review | command=`.\.venv\Scripts\python.exe scripts\run_daily_competition_controller.py --date 2026-07-06 --timezone Atlantic/Canary --mode prelock --window-minutes 90` | reason=Daily run plan lacks timing context; operator must inspect before dispatch.
