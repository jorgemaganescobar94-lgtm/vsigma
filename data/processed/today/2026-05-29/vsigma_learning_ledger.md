...
- data blocked rows: 2
- top improvement signals: WAIT_FOR_POST_RESULTS=2; UNKNOWN=1

## Market Family Summary
- learning_family_counts: DATA_BLOCKED=2; UNRESOLVED=1
- learning_status_counts: DATA_REVIEW=2; COLLECT_MORE_SAMPLE=1
