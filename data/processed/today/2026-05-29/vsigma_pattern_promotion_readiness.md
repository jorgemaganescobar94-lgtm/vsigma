# vSIGMA Pattern Promotion Readiness - 2026-05-29

## Executive Readiness Summary
- generated_at: 2026-05-29T13:28:53+01:00
- executive_status: SHADOW_EXPERIMENT_REQUIRED
- patterns_reviewed: 13
- readiness_counts: DATA_QUALITY_REVIEW=8; MONITOR_ONLY=2; SHADOW_REQUIRED=1; BLOCKED_BY_SAMPLE_SIZE=1; MONITOR_MORE_EVIDENCE=1
- auto_apply: NO
...
- #3 | DATA_QUALITY_REVIEW | key=UNRESOLVED_RESULTS | sample=15 | closed=0 | next=CLEAN_EVIDENCE | reason=Pattern is data-quality related and should not become predictive change.
...
- #5 | DATA_QUALITY_REVIEW | key=UNRESOLVED::UNKNOWN_MARKET::UNKNOWN_RISK::NO_SIGNAL | sample=8 | closed=0 | next=CLEAN_EVIDENCE | reason=Pattern is data-quality related and should not become predictive change.
- #6 | DATA_QUALITY_REVIEW | key=OVER_1_5::UNKNOWN_RISK | sample=7 | closed=0 | next=CLEAN_EVIDENCE | reason=Pattern is data-quality related and should not become predictive change.
- #7 | DATA_QUALITY_REVIEW | key=UNRESOLVED::OVER_1_5::UNKNOWN_RISK::NO_SIGNAL | sample=7 | closed=0 | next=CLEAN_EVIDENCE | reason=Pattern is data-quality related and should not become predictive change.
- #8 | DATA_QUALITY_REVIEW | key=DATA_BLOCKED | sample=2 | closed=0 | next=CLEAN_EVIDENCE | reason=Pattern is data-quality related and should not become predictive change.
...
- #11 | MONITOR_MORE_EVIDENCE | key=DATA_BLOCKED::OVER_1_5::FAILURE_MODE_LOW_CONVERSION::WAIT_FOR_POST_RESULTS | sample=2 | closed=0 | next=COLLECT_MORE_SAMPLES | reason=Model-shadow proposal exists but evidence is not promotion-ready.
