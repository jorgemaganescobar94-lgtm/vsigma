# vSIGMA Learning Patterns - 2026-05-30

## Executive Pattern Summary
- generated_at: 2026-05-30T13:02:45+01:00
- patterns detected: 10
- pattern_type_counts: MARKET_RISK_CLUSTER=4, SAMPLE_KEY_CLUSTER=4, WAITING_PRELOCK_CLUSTER=1, EXPIRED_PRELOCK_CLUSTER=1
- severity_counts: P2=8, P1=1, P3=1
...
- P2 | SAMPLE_KEY_CLUSTER | UNRESOLVED::OVER_1_5::UNKNOWN_RISK::NO_SIGNAL | n=10 | recommendation=Keep collecting evidence; repeated sample key can feed improvement proposal only after sufficient closed results.
...
- P2 | SAMPLE_KEY_CLUSTER | UNRESOLVED::OVER_2_5::UNKNOWN_RISK::NO_SIGNAL | n=4 | recommendation=Keep collecting evidence; repeated sample key can feed improvement proposal only after sufficient closed results.
