...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Flamengo vs Palmeiras | OVER_1_5 | EXECUTABLE | NONE | UNRESOLVED | ACTIONABLE_UNRESOLVED | NEEDS_MORE_DATA | WAIT_FOR_POST_RESULTS |
...
| Tokyo Verdy vs Yokohama F. Marinos | OVER_1_5 | WAIT | OUTSIDE_PRELOCK_WINDOW | UNRESOLVED | WAIT_UNRESOLVED | NEEDS_MORE_DATA | WAIT_FOR_POST_RESULTS |
