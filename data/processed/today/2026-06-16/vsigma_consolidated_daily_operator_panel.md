...
## No Bet
- #1 | NO_BET | FK Zalgiris Vilnius vs Panevėžys | market=NO_CLEAR_STAT_MARKET | stake=NO_STAKE | permission=NO | conf=LOW | score=-42
- #2 | NO_BET | Suduva Marijampole vs Šiauliai | market=NO_CLEAR_STAT_MARKET | stake=NO_STAKE | permission=NO | conf=LOW | score=-42
- #3 | NO_BET | TransINVEST Vilnius vs FK Trakai | market=NO_CLEAR_STAT_MARKET | stake=NO_STAKE | permission=NO | conf=LOW | score=-42
...
- forecast_warning_counts: PARTIAL_RECENT_STATS=3; SHOT_SAMPLE_WEAK=3; CORNER_SAMPLE_WEAK=3; CARD_SAMPLE_WEAK=3
- missing_data_counts: league_coverage=PARTIAL=3; recent_stats_coverage=NONE=3; lineup_coverage=NONE=3; injuries_coverage=NONE=3; standings_coverage=NONE=3; odds_coverage=NONE=3
...
- blocked_rows: 0
- review_priority_counts: P1_MANUAL_REVIEW=14; P2_MANUAL_REVIEW=13
...
- P1_MANUAL_REVIEW | Al Ahed vs Al Hikma | status=API_ENRICHED_REVIEW_READY | score=77 | canonical=NO_CANONICAL_BOARD_PERMISSION | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION | summary=prediction_winner=Al Hikma | pred_total_home_away=42.7/57.5 | 1x2=1.48/3.95/5.80 | ou2.5=1.95/1.77
...
- data/processed/today/2026-06-16/vsigma_probable_lineup_consensus.csv: rows=3
...
- .vsigma/triggers/daily_chain_self_heal.trigger: date=2026-06-16; reason=normalize_daily_chain_self_heal_date; triggered_at=2026-06-16T13:26:38+01:00
- .vsigma/triggers/daily_decision_chain_v2.trigger: date=2026-06-16; reason=normalize_daily_decision_chain_v2_date; triggered_at=2026-06-16T13:26:38+01:00
- .vsigma/triggers/prelock_official_lineup_recheck.trigger: date=2026-06-16; reason=normalize_prelock_recheck_date; triggered_at=2026-06-16T13:26:38+01:00
...
- not_trusted_rows: 15
- promoted_rows: 0
- gap_status_counts: MISSING_SCORED_ROW=44; NOT_TRUSTED_SKIPPED=15; SCORED_ROW_NO_DATA_BLOCKED=3
...
- risk_label_counts: MEDIUM=44
- priority_counts: P1_TRUSTED_MISSING_SCORING=44
- total_estimated_call_units: 220
...
- finished_rows: 5
- pending_rows: 22
- accuracy_bucket_counts: PENDING_RESULT=22; PARTIAL_SIGNAL_VALIDATED=2; STRONG_SIGNAL_VALIDATED=2; SIGNAL_FAILED=1
- api_1x2_counts: PENDING_RESULT=22; MISS=3; HIT=2
- api_double_chance_counts: PENDING_RESULT=22; HIT=4; MISS=1
- api_dnb_counts: PENDING_RESULT=22; VOID=2; HIT=2; MISS=1
- over_1_5_counts: PENDING_RESULT=22; HIT=4; MISS=1
- over_2_5_counts: PENDING_RESULT=22; HIT=3; MISS=2
- under_3_5_counts: PENDING_RESULT=22; HIT=3; MISS=2
- btts_counts: PENDING_RESULT=22; HIT=4; MISS=1
- pick_permission_counts: NO_PICK_PERMISSION=27
- stake_permission_counts: NO_STAKE_PERMISSION=27
