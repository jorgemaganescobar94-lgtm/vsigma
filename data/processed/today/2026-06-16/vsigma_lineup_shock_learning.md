# vSIGMA Lineup Shock Learning - 2026-06-16

## Summary
- lineup_rows: 8
- lineup_data_status_counts: HAS_LINEUP_DATA=6; NO_LINEUP_DATA=2
- lineup_shock_status_counts: OFFICIAL_LINEUP_AVAILABLE_NO_BET_REVIEW=5; DIAGNOSTIC_NO_LINEUP_LEARNING=1; LINEUP_DATA_MISSING=1; OFFICIAL_LINEUP_AVAILABLE_NEUTRAL=1
- lineup_learning_label_counts: NO_BET_LINEUP_REVIEW=5; DIAGNOSTIC_NOT_REAL_FIXTURE=1; NO_LINEUP_SIGNAL=1; LINEUP_CONTEXT_PRESENT=1
- shock_evidence_level_counts: MEDIUM=5; LOW=2; NONE=1
- manual_review_required_counts: YES=5; NO=3
- auto_apply: NO
