# vSIGMA Daily Operator Brief - 2026-06-16
...
- WINDOWS_READ=UTF8 | Get-Content data/processed/today/2026-06-16/vsigma_operator_brief.md -Encoding UTF8
...
## No Bet
- #1 | NO_BET | FK Zalgiris Vilnius vs Panevėžys | market=NO_CLEAR_STAT_MARKET | bucket=BLOCKED | conf=LOW | score=-42 | cancel=default no bet; low forecast confidence
- #2 | NO_BET | Suduva Marijampole vs Šiauliai | market=NO_CLEAR_STAT_MARKET | bucket=BLOCKED | conf=LOW | score=-42 | cancel=default no bet; low forecast confidence
- #3 | NO_BET | TransINVEST Vilnius vs FK Trakai | market=NO_CLEAR_STAT_MARKET | bucket=BLOCKED | conf=LOW | score=-42 | cancel=default no bet; low forecast confidence
...
- data/processed/today/2026-06-16/vsigma_issue_alert_status.md
