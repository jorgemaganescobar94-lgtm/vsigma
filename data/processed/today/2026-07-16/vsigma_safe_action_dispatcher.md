# vSIGMA Safe Action Dispatcher - 2026-07-16

## Executive Dispatcher Summary
- generated_at: 2026-07-16T02:21:58+01:00
...
## Dispatch Queue
- #1 | MANUAL_TIMING_REVIEW_REQUIRED | allowed=NO | fixture=1554387 | market=HOME_WIN | phase=manual_timing_review | command=`.\.venv\Scripts\python.exe scripts\run_daily_competition_controller.py --date 2026-07-16 --timezone Atlantic/Canary --mode prelock --window-minutes 90` | reason=Daily run plan lacks timing context; operator must inspect before dispatch.
