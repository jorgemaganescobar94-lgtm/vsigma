# vSIGMA Evidence Action Router - 2026-07-16

## Executive Action Routing Summary
- generated_at: 2026-07-16T02:10:39+01:00
...
## Routed Actions
- #1 | PRELOCK_CONTEXT_MISSING | fixture=1554387 | market=HOME_WIN | gate=MANUAL_TIMING_REVIEW | phase=prelock_context_review | command=`.\.venv\Scripts\python.exe scripts\run_daily_competition_controller.py --date 2026-07-16 --timezone Atlantic/Canary --mode prelock --window-minutes 90` | reason=No daily_run_plan row found for this fixture; operator must inspect timing before execution.
