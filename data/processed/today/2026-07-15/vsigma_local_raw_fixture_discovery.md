...
- accepted_rows: 1
- rejected_rows: 2
- source_status_counts: NO_SAME_DAY_ROWS=1777; EMPTY_OR_UNREADABLE=1345; NO_ACCEPTED_ROWS=3; HAS_ACCEPTED_ROWS=1
- next_action: Review accepted rows, then feed normal scoring gates.
- auto_apply: NO
- production_change: NO

## Accepted Rows
- The New Saints vs Sabah FA | fixture_id=1554387 | league=UEFA Champions League | source=data/processed/governance/vsigma_match_stat_forecasts.csv
...
- data/processed/governance/vsigma_promoted_raw_fixture_candidates.csv | status=NO_SAME_DAY_ROWS | rows=11 | same_day=0 | accepted=0 | rejected=0 | detail=file has no target-date rows
...
- data/processed/governance/vsigma_trusted_raw_fixture_candidates.csv | status=NO_SAME_DAY_ROWS | rows=138 | same_day=0 | accepted=0 | rejected=0 | detail=file has no target-date rows
