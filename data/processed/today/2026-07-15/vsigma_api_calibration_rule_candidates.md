# vSIGMA API Calibration Rule Candidates - 2026-07-15
...
## Candidate Rules
- API_CAL_RULE_0002 | ALL=ALL | API_DNB | evaluated=294 | hit=55.1 | hit_or_void=75.5 | miss=24.5 | decision=FUTURE_RULE_REVIEW_ONLY | permission=NO_RULE_ACTIVATION_PERMISSION | reason=API DNB hit_or_void=75.5% and miss_rate=24.5% meet protected-market threshold.
- API_CAL_RULE_0003 | ALL=ALL | API_DOUBLE_CHANCE | evaluated=294 | hit=75.5 | hit_or_void=75.5 | miss=24.5 | decision=FUTURE_RULE_REVIEW_ONLY | permission=NO_RULE_ACTIVATION_PERMISSION | reason=API double chance hit_rate=75.5% meets protected-market threshold.
- API_CAL_RULE_0005 | ALL=ALL | OVER_1_5 | evaluated=295 | hit=74.6 | hit_or_void=74.6 | miss=25.4 | decision=FUTURE_RULE_REVIEW_ONLY | permission=NO_RULE_ACTIVATION_PERMISSION | reason=Over 1.5 hit_rate=74.6% meets total-market threshold.
- API_CAL_RULE_0009 | PREDICTED_SIDE=AWAY | API_DNB | evaluated=141 | hit=54.6 | hit_or_void=75.9 | miss=24.1 | decision=FUTURE_RULE_REVIEW_ONLY | permission=NO_RULE_ACTIVATION_PERMISSION | reason=API DNB hit_or_void=75.9% and miss_rate=24.1% meet protected-market threshold.
- API_CAL_RULE_0010 | PREDICTED_SIDE=AWAY | API_DOUBLE_CHANCE | evaluated=141 | hit=75.9 | hit_or_void=75.9 | miss=24.1 | decision=FUTURE_RULE_REVIEW_ONLY | permission=NO_RULE_ACTIVATION_PERMISSION | reason=API double chance hit_rate=75.9% meets protected-market threshold.
- API_CAL_RULE_0012 | PREDICTED_SIDE=AWAY | OVER_1_5 | evaluated=141 | hit=78.0 | hit_or_void=78.0 | miss=22.0 | decision=FUTURE_RULE_REVIEW_ONLY | permission=NO_RULE_ACTIVATION_PERMISSION | reason=Over 1.5 hit_rate=78.0% meets total-market threshold.
...
## Block Rules
- API_CAL_RULE_0001 | ALL=ALL | API_1X2 | evaluated=294 | hit=55.1 | miss=44.9 | decision=BLOCK_ML_PROMOTION | reason=API 1X2 hit_rate=55.1% is below the 60% minimum for any ML review.
- API_CAL_RULE_0004 | ALL=ALL | BTTS_YES | evaluated=295 | hit=54.2 | miss=45.8 | decision=BLOCK_BTTS_YES_PROMOTION | reason=BTTS_YES hit_rate=54.2% is weak/negative in current calibration.
- API_CAL_RULE_0008 | PREDICTED_SIDE=AWAY | API_1X2 | evaluated=141 | hit=54.6 | miss=45.4 | decision=BLOCK_ML_PROMOTION | reason=API 1X2 hit_rate=54.6% is below the 60% minimum for any ML review.
