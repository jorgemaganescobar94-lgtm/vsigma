# vSIGMA API-Enriched Fixture Results Refresh - 2026-07-15
...
## Result Rows
- The New Saints vs Sabah FA | status=FT | score=1-2 | ready=YES | provider=API-SPORTS_DIRECT | note=fixture fetched
