# vSIGMA Max-Coverage API Enrichment Policy - 2026-07-15
...
## Policy Rows
- The New Saints vs Sabah FA | decision=FULL_ENRICHMENT_ALLOWED_FOR_SCORING | downstream=SCORING_ALLOWED_WITH_NORMAL_GATES | mode=FULL_ENRICHMENT_WITH_NORMAL_GATES | calls_executed=NO
