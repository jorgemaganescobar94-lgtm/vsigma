# vSIGMA API-Enriched Manual Review Inspector - 2026-07-15
...
## Inspector Rows
- #1 | The New Saints vs Sabah FA | priority=P2_MANUAL_REVIEW | signal_score=55 | signal_band=MEDIUM_SIGNAL_REVIEW | bucket=P3_REVIEW_LOW_SIGNAL | risk=LOW | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION | reason=Low/medium review signal. Keep as low-priority manual inspection only.
