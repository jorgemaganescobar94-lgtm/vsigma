# vSIGMA Lineup Shock Learning - 2026-06-20

## Summary
- lineup_rows: 13
- lineup_data_status_counts: HAS_LINEUP_DATA=8; NO_LINEUP_DATA=5
- lineup_shock_status_counts: OFFICIAL_LINEUP_AVAILABLE_NO_BET_REVIEW=7; DIAGNOSTIC_NO_LINEUP_LEARNING=3; LINEUP_DATA_MISSING=2; OFFICIAL_LINEUP_AVAILABLE_NEUTRAL=1
- lineup_learning_label_counts: NO_BET_LINEUP_REVIEW=7; DIAGNOSTIC_NOT_REAL_FIXTURE=3; NO_LINEUP_SIGNAL=2; LINEUP_CONTEXT_PRESENT=1
- shock_evidence_level_counts: MEDIUM=7; NONE=3; LOW=3
- manual_review_required_counts: YES=7; NO=6
- auto_apply: NO
