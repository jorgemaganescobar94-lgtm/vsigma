...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1551272 | Almeria | Malaga | OVER_2_5 | OUTSIDE_PRELOCK_WINDOW | 1165.65 | PRELOCK_NOT_AVAILABLE | fixture is outside requested pre-lock window |
...
- Recovery command: `.\.venv\Scripts\python.exe scripts\build_daily_competition_master_report.py --date 2026-06-20`
