# vSIGMA API-Enriched Fixture Results Refresh - 2026-07-04
...
## Result Rows
- Sirius vs Mjallby AIF | status=FT | score=4-4 | ready=YES | provider=API-SPORTS_DIRECT | note=fixture fetched
