# vSIGMA API-Enriched Scored Candidates - 2026-07-04
...
## Candidate Rows
- Sirius vs Mjallby AIF | status=API_ENRICHED_SCORING_READY_PENDING_GATES | fixture=YES pred=YES odds=YES | summary=prediction_winner=Sirius | pred_total_home_away=49.0/51.0 | 1x2=1.55/4.10/5.50 | ou2.5=1.62/2.30 | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION
