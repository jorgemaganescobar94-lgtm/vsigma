# vSIGMA API Calibration Rule Candidates - 2026-07-04
...
## Candidate Rules
- API_CAL_RULE_0002 | ALL=ALL | API_DNB | evaluated=284 | hit=54.2 | hit_or_void=75.4 | miss=24.6 | decision=FUTURE_RULE_REVIEW_ONLY | permission=NO_RULE_ACTIVATION_PERMISSION | reason=API DNB hit_or_void=75.4% and miss_rate=24.6% meet protected-market threshold.
- API_CAL_RULE_0003 | ALL=ALL | API_DOUBLE_CHANCE | evaluated=284 | hit=75.4 | hit_or_void=75.4 | miss=24.6 | decision=FUTURE_RULE_REVIEW_ONLY | permission=NO_RULE_ACTIVATION_PERMISSION | reason=API double chance hit_rate=75.4% meets protected-market threshold.
- API_CAL_RULE_0005 | ALL=ALL | OVER_1_5 | evaluated=285 | hit=74.4 | hit_or_void=74.4 | miss=25.6 | decision=FUTURE_RULE_REVIEW_ONLY | permission=NO_RULE_ACTIVATION_PERMISSION | reason=Over 1.5 hit_rate=74.4% meets total-market threshold.
...
- API_CAL_RULE_0016 | PREDICTED_SIDE=HOME | API_DNB | evaluated=151 | hit=56.3 | hit_or_void=76.2 | miss=23.8 | decision=FUTURE_RULE_REVIEW_ONLY | permission=NO_RULE_ACTIVATION_PERMISSION | reason=API DNB hit_or_void=76.2% and miss_rate=23.8% meet protected-market threshold.
- API_CAL_RULE_0017 | PREDICTED_SIDE=HOME | API_DOUBLE_CHANCE | evaluated=151 | hit=76.2 | hit_or_void=76.2 | miss=23.8 | decision=FUTURE_RULE_REVIEW_ONLY | permission=NO_RULE_ACTIVATION_PERMISSION | reason=API double chance hit_rate=76.2% meets protected-market threshold.
- API_CAL_RULE_0019 | PREDICTED_SIDE=HOME | OVER_1_5 | evaluated=151 | hit=71.5 | hit_or_void=71.5 | miss=28.5 | decision=FUTURE_RULE_REVIEW_ONLY | permission=NO_RULE_ACTIVATION_PERMISSION | reason=Over 1.5 hit_rate=71.5% meets total-market threshold.
...
## Block Rules
- API_CAL_RULE_0001 | ALL=ALL | API_1X2 | evaluated=284 | hit=54.2 | miss=45.8 | decision=BLOCK_ML_PROMOTION | reason=API 1X2 hit_rate=54.2% is below the 60% minimum for any ML review.
- API_CAL_RULE_0004 | ALL=ALL | BTTS_YES | evaluated=285 | hit=54.0 | miss=46.0 | decision=BLOCK_BTTS_YES_PROMOTION | reason=BTTS_YES hit_rate=54.0% is weak/negative in current calibration.
...
- API_CAL_RULE_0015 | PREDICTED_SIDE=HOME | API_1X2 | evaluated=151 | hit=56.3 | miss=43.7 | decision=BLOCK_ML_PROMOTION | reason=API 1X2 hit_rate=56.3% is below the 60% minimum for any ML review.
- API_CAL_RULE_0018 | PREDICTED_SIDE=HOME | BTTS_YES | evaluated=151 | hit=49.0 | miss=51.0 | decision=BLOCK_BTTS_YES_PROMOTION | reason=BTTS_YES hit_rate=49.0% is weak/negative in current calibration.
- API_CAL_RULE_0020 | PREDICTED_SIDE=HOME | OVER_2_5 | evaluated=151 | hit=51.0 | miss=49.0 | decision=BLOCK_OVER_2_5_PROMOTION | reason=OVER_2_5 hit_rate=51.0% is weak/negative in current calibration.
