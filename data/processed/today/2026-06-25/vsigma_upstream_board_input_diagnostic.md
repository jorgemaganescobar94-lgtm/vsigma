...
- daily_execution_board | status=EMPTY_REQUIRED | rows=0 | date=NO_ROWS | path=data/processed/today/2026-06-25/vsigma_daily_execution_board.csv | detail=required upstream file exists but has zero rows
...
- probable_lineup_consensus | status=EMPTY_OPTIONAL | rows=0 | date=NO_ROWS | path=data/processed/today/2026-06-25/vsigma_probable_lineup_consensus.csv | detail=optional upstream file has zero rows
