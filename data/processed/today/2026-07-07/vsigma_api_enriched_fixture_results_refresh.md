# vSIGMA API-Enriched Fixture Results Refresh - 2026-07-07
...
## Result Rows
- BK Hacken vs Djurgardens IF | status=FT | score=2-4 | ready=YES | provider=API-SPORTS_DIRECT | note=fixture fetched
