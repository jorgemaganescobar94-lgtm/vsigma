# vSIGMA Candidate Provenance Ceiling - 2026-07-07
...
## Ceiling Rows
- BK Hacken vs Djurgardens IF | origin=OBJECTIVE_PROXY | max=NO_BET | permission=NO_BET -> NO_BET | stake=NO_STAKE -> NO_STAKE | action=NO_CHANGE | reason=permission already within provenance ceiling or ledger missing
