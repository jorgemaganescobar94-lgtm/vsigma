# vSIGMA API-Enriched Scored Candidates - 2026-07-07
...
## Candidate Rows
- BK Hacken vs Djurgardens IF | status=API_ENRICHED_SCORING_READY_PENDING_GATES | fixture=YES pred=YES odds=YES | summary=prediction_winner=Djurgardens IF | pred_total_home_away=41.0/59.0 | 1x2=2.45/3.75/2.55 | ou2.5=1.50/2.60 | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION
