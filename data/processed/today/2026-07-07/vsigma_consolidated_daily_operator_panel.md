# vSIGMA Consolidated Daily Operator Panel - 2026-07-07
...
## No Bet
- #1 | NO_BET | BK Hacken vs Djurgardens IF | market=NO_CLEAR_STAT_MARKET | stake=NO_STAKE | permission=NO | conf=LOW | score=-34
...
- source: data/processed/today/2026-07-07/vsigma_api_enriched_review_board.csv
...
### API Review Rows
- P1_MANUAL_REVIEW | BK Hacken vs Djurgardens IF | status=API_ENRICHED_REVIEW_READY | score=82 | canonical=NO_CANONICAL_BOARD_PERMISSION | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION | summary=prediction_winner=Djurgardens IF | pred_total_home_away=41.0/59.0 | 1x2=2.45/3.75/2.55 | ou2.5=1.50/2.60
...
- data/processed/today/2026-07-07/official_lineup_sources.csv: rows=92
- data/processed/today/2026-07-07/vsigma_probable_lineup_consensus.csv: rows=1
- data/processed/governance/official_lineup_sources.csv: rows=92
...
- .vsigma/triggers/daily_chain_self_heal.trigger: date=2026-07-07; reason=normalize_daily_chain_self_heal_date; triggered_at=2026-07-07T11:38:10+01:00
- .vsigma/triggers/daily_decision_chain_v2.trigger: date=2026-07-07; reason=normalize_daily_decision_chain_v2_date; triggered_at=2026-07-07T11:38:10+01:00
- .vsigma/triggers/prelock_official_lineup_recheck.trigger: date=2026-07-07; reason=normalize_prelock_recheck_date; triggered_at=2026-07-07T11:38:10+01:00

## Key Files
- data/processed/today/2026-07-07/vsigma_consolidated_daily_operator_panel.md
- data/processed/today/2026-07-07/vsigma_operator_brief.md
- data/processed/today/2026-07-07/vsigma_daily_execution_board.md
- data/processed/today/2026-07-07/vsigma_prelock_live_recheck.md
- data/processed/today/2026-07-07/vsigma_live_trigger_validator.md
- data/processed/today/2026-07-07/vsigma_automation_health.md
- data/processed/today/2026-07-07/vsigma_probable_lineup_source_reliability_governor.md
...
- trigger_date_counts: 2026-07-07=2
