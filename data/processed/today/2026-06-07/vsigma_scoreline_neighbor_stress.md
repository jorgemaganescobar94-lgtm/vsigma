# vSIGMA Scoreline Neighbor Stress - 2026-06-07

## Summary
- scoreline_rows: 2
- scoreline_data_status_counts: NO_SCORELINE_DATA=2
- scoreline_neighbor_bucket_counts: NO_SCORELINE=2
- scoreline_stress_status_counts: DIAGNOSTIC_NO_SCORELINE_STRESS=1; SCORELINE_DATA_MISSING=1
- scoreline_learning_label_counts: DIAGNOSTIC_NOT_REAL_FIXTURE=1; NO_SCORELINE_SIGNAL=1
- stress_evidence_level_counts: NONE=1; LOW=1
...
- SCORELINE_DATA_MISSING | Castellón vs Almeria | score=NA bucket=NO_SCORELINE | market=UNKNOWN_FAMILY outcome=PENDING | label=NO_SCORELINE_SIGNAL | manual=NO | action=COLLECT_FINAL_SCORELINE_DATA
