...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | 1548053 | Segunda División | Las Palmas | Malaga | OVER_1_5 | 0.84486 | 158.877 | FAILURE_MODE_LOW_CONVERSION |

## Candidate v2 Top Picks
| accuracy_mode_rank | fixture_id | league | home_team | away_team | market_primary | competition_calibrated_prob | accuracy_confidence_score | accuracy_primary_risk |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | 1548053 | Segunda División | Las Palmas | Malaga | OVER_1_5 | 0.83986 | 157.504 | FAILURE_MODE_LOW_CONVERSION |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| BOTH | 1548053 | Las Palmas vs Malaga | Segunda División | 1 | 1 | OVER_1_5 | OVER_1_5 | 0.9125 | 0.9075 | 0.84486 | 0.83986 | 158.877 | 157.504 | ACCURACY_CORE | ACCURACY_CORE | ACCURACY_CORE_PRIORITY;ACCURACY_MARKET_STABLE;ACCURACY_OVER_CONFIRMED;ACCURACY_MODEL_PROB_HIGH;ACCURACY_FAILURE_MODE_ACCEPTABLE | ACCURACY_CORE_PRIORITY;ACCURACY_MARKET_STABLE;ACCURACY_OVER_CONFIRMED;ACCURACY_MODEL_PROB_HIGH;ACCURACY_FAILURE_MODE_ACCEPTABLE | FAILURE_MODE_LOW_CONVERSION | FAILURE_MODE_LOW_CONVERSION | 2026-06-07 | 2026-06-07T08:40:34+00:00 | PRE | COMPARISON | NO_DATE_COLUMN | 2026-06-07-20260607T084034Z |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| BASELINE+CANDIDATE_V2 | 1548053 | Las Palmas vs Malaga | Segunda División | 1 | 1 |  | OVER_1_5 | OVER_1_5 |  |  |  |  |  |  |  | 2026-06-07 | 2026-06-07T08:40:34+00:00 | PRE | COMPARISON | NO_DATE_COLUMN | 2026-06-07-20260607T084034Z |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1548053 | Las Palmas | Malaga | OVER_1_5 | PRICE_NEEDS_PRELOCK_CONFIRMATION | 0.143 | 0.203275 | 0.060275 | WATCH_PATTERN | V7_WAITING_FOR_PRELOCK | V7_WAITING_FOR_PRELOCK | CLV_UNAVAILABLE | Watch-pattern drift requires explicit pre-lock confirmation before execution. |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1548053 | Las Palmas | Malaga | OVER_1_5 | PRICE_NEEDS_PRELOCK_CONFIRMATION | V7_WAITING_FOR_PRELOCK | V7_WAITING_FOR_PRELOCK | 0 | Watch-pattern drift requires explicit pre-lock confirmation before execution. |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1548053 | Las Palmas | Malaga | OVER_1_5 | OUTSIDE_PRELOCK_WINDOW | 619.77 | PRELOCK_NOT_AVAILABLE | fixture is outside requested pre-lock window |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1548053 | Las Palmas | Malaga | OVER_1_5 | CANDIDATE_V2_SCHEDULE_ANOMALY | 1.42 |  |  |  | CLV_UNAVAILABLE |  |  |
| 1548053 | Las Palmas | Malaga | OVER_1_5 | DEEP_ANALYSIS_CANDIDATES | 1.42 |  |  |  | CLV_UNAVAILABLE |  |  |
| 1548053 | Las Palmas | Malaga | OVER_1_5 | OFFICIAL_BASELINE | 1.42 |  |  |  | CLV_UNAVAILABLE |  |  |
...
- Pre-lock due time: 2026-06-07T17:30:20.200000+00:00
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| OFFICIAL_BASELINE | 1548053.0 | Las Palmas | Malaga | OVER_1_5 | PRELOCK_NOT_AVAILABLE | PENDING |  | PRELOCK_UPDATED |
| CANDIDATE_V2_SCHEDULE_ANOMALY | 1548053.0 | Las Palmas | Malaga | OVER_1_5 | PRELOCK_NOT_AVAILABLE | PENDING |  | PRELOCK_UPDATED |
| CANDIDATE_V3_ODDS_DEPTH |  |  |  |  |  |  |  | NO_BET_RECORD |
| CANDIDATE_V4_O25_FIREWALL | 1548053.0 | Las Palmas | Malaga | OVER_1_5 | PRELOCK_NOT_AVAILABLE | PENDING |  | PRELOCK_UPDATED |
| CANDIDATE_V5_PLAYER_IMPACT | 1548053.0 | Las Palmas | Malaga | OVER_1_5 | PRELOCK_NOT_AVAILABLE | PENDING |  | PRELOCK_UPDATED |
| CANDIDATE_V6_API_PREDICTIONS | 1548053.0 | Las Palmas | Malaga | OVER_1_5 | PRELOCK_NOT_AVAILABLE | PENDING |  | PRELOCK_UPDATED |
| CANDIDATE_V7_PRICE_DISCIPLINE | 1548053.0 | Las Palmas | Malaga | OVER_1_5 | PRELOCK_NOT_AVAILABLE | PENDING |  | PRELOCK_UPDATED |
...
| FAILURE_MODE_LOW_CONVERSION; market=OVER_1_5; edge=0.203; market_fit=SAFE_OK | 4 |
| FAILURE_MODE_LOW_CONVERSION; market=OVER_1_5; edge=0.208; market_fit=SAFE_OK | 1 |
...
| vsigma_today_prelock_comparison.csv | PRELOCK_COMPARISON | WARNING_STALE_GLOBAL_FILE | metadata target_date=['2026-06-06'] does not match 2026-06-07 | 1 |
