# vSIGMA System Review - 2026-06-07
...
- Decision outcome ledger rows total: 63
- Decision outcome ledger actionable rows: 8
- Decision outcome ledger non-actionable rows: 55
- Decision outcome ledger no bet rows: 34
- Decision outcome ledger expired rows: 22
- Decision outcome ledger waiting rows: 21
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1548053 | Segunda División | Las Palmas | Malaga | OVER_1_5 | NO_BET | NO | KICKOFF_ALREADY_PASSED | NO |  |  | EXPIRED |  | KICKOFF_ALREADY_PASSED |  |
...
- odds structure depth: target_fixtures: 1; API_ERROR_FALLBACK: 1; RICH_COHERENT: 1; BALANCED: 1; CAUTION_FRAGILE_SIDE: 1
