# vSIGMA No Bet Audit - 2026-06-07
...
## Audit Rows
- NO_BET_AUDIT_PENDING_FINAL_ACTUALS | Castellón vs Almeria | quality=PENDING | evidence=NO_POSTMATCH_PRESSURE_METRICS | missed=PENDING | protection=PENDING | manual=NO | note=Real No Bet row but final actuals are not available yet.
