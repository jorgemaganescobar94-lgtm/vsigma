...
- Ledger rows total: 124
- Ledger rows for target date: 7
- Decision outcome ledger rows total: 39
- Decision outcome ledger actionable rows: 6
- Decision outcome ledger non-actionable rows: 33
- Decision outcome ledger no bet rows: 18
- Decision outcome ledger expired rows: 15
- Decision outcome ledger waiting rows: 15
- Decision outcome ledger blocked rows: 3
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1544608 | UEFA Europa Conference League | Crystal Palace | Rayo Vallecano | OVER_1_5 | WAIT | NO | OUTSIDE_PRELOCK_WINDOW | YES | 2026-05-27T19:00+01:00 |  | WAITING_FOR_WINDOW |  | OUTSIDE_90_MIN_PRELOCK_WINDOW |  |
...
- odds structure depth: target_fixtures: 15; OK: 14; NO_ODDS_FOUND: 1; RICH_MIXED: 9; RICH_COHERENT: 4
- API gaps detected: fixture_stats, injuries

## Model / Market Review
- markets appearing in current/historical inputs: OVER_1_5: 99; OVER_2_5: 18; BTTS_YES: 3; UNDER_3_5: 3; AWAY_WIN: 2
- failure modes principales: FAILURE_MODE_LOW_CONVERSION: 156; LOW_CONVERSION: 78; FAILURE_MODE_AVALANCHE_RISK: 2
...
## Input Inventory
- generated_at: 2026-05-27T01:20:27+01:00
