# vSIGMA System Review - 2026-05-27
...
- Ledger rows total: 130
- Ledger rows for target date: 13
- Decision outcome ledger rows total: 41
- Decision outcome ledger actionable rows: 6
- Decision outcome ledger non-actionable rows: 35
- Decision outcome ledger no bet rows: 19
- Decision outcome ledger expired rows: 15
- Decision outcome ledger waiting rows: 16
- Decision outcome ledger blocked rows: 4
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1544608 | UEFA Europa Conference League | Crystal Palace | Rayo Vallecano | OVER_1_5 | NO_BET | NO | ODDS_NOT_AVAILABLE;LINEUPS_NOT_AVAILABLE;AVAILABILITY_NOT_AVAILABLE | NO |  | ODDS_MISSING;LINEUPS_MISSING;AVAILABILITY_MISSING | DATA_GAP_BLOCKED |  | PRELOCK_NOT_AVAILABLE |  |
| 1535322 | CONMEBOL Libertadores | Independiente del Valle | Rosario Central | OVER_1_5 | WAIT | NO | OUTSIDE_PRELOCK_WINDOW | YES | 2026-05-27T22:00+01:00 |  | WAITING_FOR_WINDOW |  | OUTSIDE_90_MIN_PRELOCK_WINDOW |  |

## Data Coverage Review
- coverage rich / partial / weak: COVERAGE_RICH: 3; COVERAGE_PARTIAL: 1
- odds coverage: 4/4
- fixture stats coverage: 3/4
- injuries coverage: 1/4
- lineups coverage: 4/4
- predictions coverage: 4/4
- odds structure depth: target_fixtures: 9; OK: 9; RICH_MIXED: 6; RICH_COHERENT: 2; RICH_NOISY: 1
- API gaps detected: fixture_stats, injuries

## Model / Market Review
- markets appearing in current/historical inputs: OVER_1_5: 106; OVER_2_5: 18; BTTS_YES: 3; UNDER_3_5: 3; AWAY_WIN: 2
- failure modes principales: FAILURE_MODE_LOW_CONVERSION: 168; LOW_CONVERSION: 84; FAILURE_MODE_AVALANCHE_RISK: 2
- OVER_1_5: appearances=106; calibration_sample=7; status=needs more sample
...
## Input Inventory
- generated_at: 2026-05-27T19:14:32+01:00
