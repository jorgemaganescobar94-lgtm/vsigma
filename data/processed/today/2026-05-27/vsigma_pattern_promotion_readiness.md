# vSIGMA Pattern Promotion Readiness - 2026-05-27

## Executive Readiness Summary
- generated_at: 2026-05-27T13:40:14+01:00
...
- #2 | BLOCKED_BY_SAMPLE_SIZE | key=OVER_1_5::FAILURE_MODE_LOW_CONVERSION | sample=6 | closed=1 | next=CONTINUE_SHADOW_FORWARD_TEST | reason=Only 1 closed samples; minimum review sample is 30.
- #3 | DATA_QUALITY_REVIEW | key=UNRESOLVED_RESULTS | sample=14 | closed=0 | next=CLEAN_EVIDENCE | reason=Pattern is data-quality related and should not become predictive change.
...
- #10 | MONITOR_ONLY | key=WAITING_PRELOCK | sample=5 | closed=0 | next=KEEP_MONITORING | reason=Proposal does not clear shadow or promotion gates.
