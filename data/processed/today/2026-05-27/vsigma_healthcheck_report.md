...
- Generated at: 2026-05-27T01:18:32.493674+01:00
- Mode: full
- HEALTHY: 29
- WARNING: 7
- NEEDS_ATTENTION: 0
- BROKEN: 0
- NOT_RUN_YET: 1
- First recovery command: `.\.venv\Scripts\python.exe scripts\run_daily_competition_controller.py --date 2026-05-27 --timezone Atlantic/Canary --mode pre`

## Critical Warnings
| check_name | status | detail | recovery_command |
| --- | --- | --- | --- |
| official_baseline_output | WARNING | only stale rows found for 2026-05-26 | .\.venv\Scripts\python.exe scripts\run_daily_competition_controller.py --date 2026-05-27 --timezone Atlantic/Canary --mode pre |
| daily_master_report | WARNING | daily master report missing | .\.venv\Scripts\python.exe scripts\build_daily_competition_master_report.py --date 2026-05-27 |
| ledger_target_date_rows | WARNING | ledger has no rows for target date | .\.venv\Scripts\python.exe scripts\update_immutable_daily_ledger.py --date 2026-05-27 --stage PRE |
| freshness_report | WARNING | validation report contains warning rows | .\.venv\Scripts\python.exe scripts\validate_daily_output_freshness.py --date 2026-05-27 |
| prelock_freshness | WARNING | stale prelock rows found for 2026-05-26 | .\.venv\Scripts\python.exe scripts\run_today_prelock_orchestrator.py --date 2026-05-27 --timezone Atlantic/Canary --window-minutes 90 |
| post_results_status | WARNING | post-results report missing while official picks exist | .\.venv\Scripts\python.exe scripts\run_daily_competition_controller.py --date 2026-05-27 --timezone Atlantic/Canary --mode post |
...
| today_snapshot_folder | HEALTHY | today snapshot folder present | .\.venv\Scripts\python.exe scripts\run_daily_competition_controller.py --date 2026-05-27 --timezone Atlantic/Canary --mode pre | /home/runner/work/vsigma/vsigma/data/processed/today/2026-05-27 |
| official_baseline_output | WARNING | only stale rows found for 2026-05-26 | .\.venv\Scripts\python.exe scripts\run_daily_competition_controller.py --date 2026-05-27 --timezone Atlantic/Canary --mode pre | /home/runner/work/vsigma/vsigma/data/processed/vsigma_today_competition_top.csv |
...
| daily_master_report | WARNING | daily master report missing | .\.venv\Scripts\python.exe scripts\build_daily_competition_master_report.py --date 2026-05-27 | /home/runner/work/vsigma/vsigma/data/processed/today/2026-05-27/daily_competition_master_report.md |
...
| ledger_target_date_rows | WARNING | ledger has no rows for target date | .\.venv\Scripts\python.exe scripts\update_immutable_daily_ledger.py --date 2026-05-27 --stage PRE | /home/runner/work/vsigma/vsigma/data/processed/ledger/vsigma_immutable_daily_pick_ledger.csv |
...
| freshness_report | WARNING | validation report contains warning rows | .\.venv\Scripts\python.exe scripts\validate_daily_output_freshness.py --date 2026-05-27 | /home/runner/work/vsigma/vsigma/data/processed/vsigma_daily_freshness_report.csv |
...
| prelock_freshness | WARNING | stale prelock rows found for 2026-05-26 | .\.venv\Scripts\python.exe scripts\run_today_prelock_orchestrator.py --date 2026-05-27 --timezone Atlantic/Canary --window-minutes 90 | /home/runner/work/vsigma/vsigma/data/processed/vsigma_today_prelock_comparison.csv |
...
| disk_space | HEALTHY | free disk space acceptable: 16.03 GB |  |  |
