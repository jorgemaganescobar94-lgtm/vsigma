...
- accepted_rows: 3
- rejected_rows: 6
- source_status_counts: NO_SAME_DAY_ROWS=1814; EMPTY_OR_UNREADABLE=1372; NO_ACCEPTED_ROWS=3; HAS_ACCEPTED_ROWS=1
- next_action: Review accepted rows, then feed normal scoring gates.
- auto_apply: NO
- production_change: NO

## Accepted Rows
- Malisheva vs Vllaznia Shkodër | fixture_id=1554428 | league=UEFA Europa Conference League | source=data/processed/governance/vsigma_match_stat_forecasts.csv
- Atert Bissen vs KI Klaksvik | fixture_id=1554375 | league=UEFA Champions League | source=data/processed/governance/vsigma_match_stat_forecasts.csv
- Universitatea Craiova vs ML Vitebsk | fixture_id=1554388 | league=UEFA Champions League | source=data/processed/governance/vsigma_match_stat_forecasts.csv
...
- data/processed/governance/vsigma_api_enriched_fixture_results_refresh.csv | status=NO_SAME_DAY_ROWS | rows=3 | same_day=0 | accepted=0 | rejected=0 | detail=file has no target-date rows
...
- data/processed/governance/vsigma_promoted_api_enriched_candidates.csv | status=NO_SAME_DAY_ROWS | rows=3 | same_day=0 | accepted=0 | rejected=0 | detail=file has no target-date rows
