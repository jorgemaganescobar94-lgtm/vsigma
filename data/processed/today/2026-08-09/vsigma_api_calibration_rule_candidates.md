# vSIGMA API Calibration Rule Candidates - 2026-08-09
...
## Candidate Rules
- API_CAL_RULE_0002 | ALL=ALL | API_DNB | evaluated=338 | hit=53.8 | hit_or_void=77.5 | miss=22.5 | decision=FUTURE_RULE_REVIEW_ONLY | permission=NO_RULE_ACTIVATION_PERMISSION | reason=API DNB hit_or_void=77.5% and miss_rate=22.5% meet protected-market threshold.
- API_CAL_RULE_0003 | ALL=ALL | API_DOUBLE_CHANCE | evaluated=338 | hit=77.5 | hit_or_void=77.5 | miss=22.5 | decision=FUTURE_RULE_REVIEW_ONLY | permission=NO_RULE_ACTIVATION_PERMISSION | reason=API double chance hit_rate=77.5% meets protected-market threshold.
- API_CAL_RULE_0005 | ALL=ALL | OVER_1_5 | evaluated=339 | hit=76.7 | hit_or_void=76.7 | miss=23.3 | decision=FUTURE_RULE_REVIEW_ONLY | permission=NO_RULE_ACTIVATION_PERMISSION | reason=Over 1.5 hit_rate=76.7% meets total-market threshold.
- API_CAL_RULE_0009 | PREDICTED_SIDE=AWAY | API_DNB | evaluated=174 | hit=50.0 | hit_or_void=78.2 | miss=21.8 | decision=FUTURE_RULE_REVIEW_ONLY | permission=NO_RULE_ACTIVATION_PERMISSION | reason=API DNB hit_or_void=78.2% and miss_rate=21.8% meet protected-market threshold.
- API_CAL_RULE_0010 | PREDICTED_SIDE=AWAY | API_DOUBLE_CHANCE | evaluated=174 | hit=78.2 | hit_or_void=78.2 | miss=21.8 | decision=FUTURE_RULE_REVIEW_ONLY | permission=NO_RULE_ACTIVATION_PERMISSION | reason=API double chance hit_rate=78.2% meets protected-market threshold.
- API_CAL_RULE_0012 | PREDICTED_SIDE=AWAY | OVER_1_5 | evaluated=174 | hit=82.2 | hit_or_void=82.2 | miss=17.8 | decision=FUTURE_RULE_REVIEW_ONLY | permission=NO_RULE_ACTIVATION_PERMISSION | reason=Over 1.5 hit_rate=82.2% meets total-market threshold.
...
- API_CAL_RULE_0040 | REVIEW_PRIORITY=P2_MANUAL_REVIEW | OVER_1_5 | evaluated=174 | hit=77.6 | hit_or_void=77.6 | miss=22.4 | decision=FUTURE_RULE_REVIEW_ONLY | permission=NO_RULE_ACTIVATION_PERMISSION | reason=Over 1.5 hit_rate=77.6% meets total-market threshold.
...
- API_CAL_RULE_0051 | SCORE_BUCKET=SCORE_70_79 | API_DNB | evaluated=107 | hit=57.0 | hit_or_void=76.6 | miss=23.4 | decision=FUTURE_RULE_REVIEW_ONLY | permission=NO_RULE_ACTIVATION_PERMISSION | reason=API DNB hit_or_void=76.6% and miss_rate=23.4% meet protected-market threshold.
- API_CAL_RULE_0052 | SCORE_BUCKET=SCORE_70_79 | API_DOUBLE_CHANCE | evaluated=107 | hit=76.6 | hit_or_void=76.6 | miss=23.4 | decision=FUTURE_RULE_REVIEW_ONLY | permission=NO_RULE_ACTIVATION_PERMISSION | reason=API double chance hit_rate=76.6% meets protected-market threshold.
- API_CAL_RULE_0054 | SCORE_BUCKET=SCORE_70_79 | OVER_1_5 | evaluated=107 | hit=80.4 | hit_or_void=80.4 | miss=19.6 | decision=FUTURE_RULE_REVIEW_ONLY | permission=NO_RULE_ACTIVATION_PERMISSION | reason=Over 1.5 hit_rate=80.4% meets total-market threshold.
...
- API_CAL_RULE_0082 | SIGNAL_BAND=MEDIUM_SIGNAL_REVIEW | OVER_1_5 | evaluated=174 | hit=77.6 | hit_or_void=77.6 | miss=22.4 | decision=FUTURE_RULE_REVIEW_ONLY | permission=NO_RULE_ACTIVATION_PERMISSION | reason=Over 1.5 hit_rate=77.6% meets total-market threshold.

## Block Rules
- API_CAL_RULE_0001 | ALL=ALL | API_1X2 | evaluated=338 | hit=53.8 | miss=46.2 | decision=BLOCK_ML_PROMOTION | reason=API 1X2 hit_rate=53.8% is below the 60% minimum for any ML review.
- API_CAL_RULE_0006 | ALL=ALL | OVER_2_5 | evaluated=339 | hit=53.7 | miss=46.3 | decision=BLOCK_OVER_2_5_PROMOTION | reason=OVER_2_5 hit_rate=53.7% is weak/negative in current calibration.
- API_CAL_RULE_0008 | PREDICTED_SIDE=AWAY | API_1X2 | evaluated=174 | hit=50.0 | miss=50.0 | decision=BLOCK_ML_PROMOTION | reason=API 1X2 hit_rate=50.0% is below the 60% minimum for any ML review.
...
- API_CAL_RULE_0036 | REVIEW_PRIORITY=P2_MANUAL_REVIEW | API_1X2 | evaluated=174 | hit=52.3 | miss=47.7 | decision=BLOCK_ML_PROMOTION | reason=API 1X2 hit_rate=52.3% is below the 60% minimum for any ML review.
...
- API_CAL_RULE_0050 | SCORE_BUCKET=SCORE_70_79 | API_1X2 | evaluated=107 | hit=57.0 | miss=43.0 | decision=BLOCK_ML_PROMOTION | reason=API 1X2 hit_rate=57.0% is below the 60% minimum for any ML review.
- API_CAL_RULE_0053 | SCORE_BUCKET=SCORE_70_79 | BTTS_YES | evaluated=107 | hit=54.2 | miss=45.8 | decision=BLOCK_BTTS_YES_PROMOTION | reason=BTTS_YES hit_rate=54.2% is weak/negative in current calibration.
...
- API_CAL_RULE_0078 | SIGNAL_BAND=MEDIUM_SIGNAL_REVIEW | API_1X2 | evaluated=174 | hit=52.3 | miss=47.7 | decision=BLOCK_ML_PROMOTION | reason=API 1X2 hit_rate=52.3% is below the 60% minimum for any ML review.
