...
## Summary
- rows_translated: 6
- execution_permission_counts: STAT_WATCH_ONLY=2; REVIEW_LOW_STAKE=1; LIVE_ONLY=1; NO_BET=1; NO_BET_OR_WATCH=1
...
- #2 | STAT_WATCH_ONLY | IFK Goteborg vs Mjallby AIF | primary=OVER_1_5_SUPPORTED | secondary=OVER_2_5_REVIEW | score=37 | stake=NO_STAKE_OR_SYMBOLIC | kill=NO_PORTFOLIO_CONTEXT | reason=stat_score=55; confidence=MEDIUM 66.6; portfolio=NO_PORTFOLIO_CONTEXT; statistical watch only; no portfolio/context confirmation
- #3 | STAT_WATCH_ONLY | Sandefjord vs Fredrikstad | primary=OVER_1_5_SUPPORTED | secondary=BTTS_OR_OVER_1_5_REVIEW | score=32 | stake=NO_STAKE_OR_SYMBOLIC | kill=NO_PORTFOLIO_CONTEXT | reason=stat_score=50; confidence=MEDIUM 66.6; portfolio=NO_PORTFOLIO_CONTEXT; statistical watch only; no portfolio/context confirmation
