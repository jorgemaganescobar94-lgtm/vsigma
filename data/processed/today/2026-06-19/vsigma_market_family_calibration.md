# vSIGMA Market Family Calibration - 2026-06-19
...
## Family Rows
- NO_MARKET | real=0/4 | green=0 red=0 void=0 | gate=INSUFFICIENT_SAMPLE | status=HOLD_SAMPLE | signal=NO_WEIGHT_CHANGE | action=Collect more market-family samples before changing confidence.
...
- UNKNOWN_FAMILY | real=0/6 | green=0 red=0 void=0 | gate=INSUFFICIENT_SAMPLE | status=HOLD_SAMPLE | signal=NO_WEIGHT_CHANGE | action=Collect more market-family samples before changing confidence.
