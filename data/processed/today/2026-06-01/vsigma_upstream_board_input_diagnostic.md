...
- probable_lineup_consensus | status=OK | rows=1 | date=OK | path=data/processed/today/2026-06-01/vsigma_probable_lineup_consensus.csv | detail=file has rows and passed basic diagnostic checks
