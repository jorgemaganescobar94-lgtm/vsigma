# vSIGMA Data Quality Governor - 2026-06-01

## Executive Data Quality Summary
- generated_at: 2026-06-01T20:26:13+01:00
- executive_status: DATA_QUALITY_REVIEW_REQUIRED
- issues: 19
- severity_counts: P3=19
- issue_type_counts: DATA_QUALITY_BLOCKER=8; UNRESOLVED_RESULTS=4; DATA_QUALITY_PROPOSAL=3; NO_SIGNAL=1; UNKNOWN_MARKET=1; UNKNOWN_RISK=1; UNRESOLVED_LEDGER_ROWS=1
- auto_fix: NO
- production_change: NO

## Prioritized Issues
- P3 | NO_SIGNAL | n=2 | key=NO_SIGNAL | action=Populate improvement_signal or classify as monitor-only.
- P3 | UNKNOWN_MARKET | n=2 | key=UNKNOWN_MARKET | action=Normalize missing market_primary before pattern mining.
- P3 | UNKNOWN_RISK | n=2 | key=UNKNOWN_RISK | action=Populate accuracy_primary_risk before pattern mining.
- P3 | UNRESOLVED_LEDGER_ROWS | n=2 | key=RESULT_STATUS_UNRESOLVED | action=Run/verify post-result labeling until learning rows close.
