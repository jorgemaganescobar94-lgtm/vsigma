# vSIGMA API-Enriched Scored Candidates - 2026-08-03
...
## Candidate Rows
- Dundee Utd vs Rangers | status=API_ENRICHED_SCORING_READY_PENDING_GATES | fixture=YES pred=YES odds=YES | summary=prediction_winner=Rangers | pred_total_home_away=25.5/74.5 | 1x2=5.00/3.90/1.64 | ou2.5=3.40/1.28 | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION
