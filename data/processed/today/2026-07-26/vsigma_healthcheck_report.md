# vSIGMA Healthcheck Report - 2026-07-26

- Global health status: WARNING
- Generated at: 2026-07-26T18:09:02.270060+01:00
- Mode: full
- HEALTHY: 33
- WARNING: 3
- NEEDS_ATTENTION: 0
- BROKEN: 0
- NOT_RUN_YET: 1
- First recovery command: `.\.venv\Scripts\python.exe scripts\validate_daily_output_freshness.py --date 2026-07-26`

## Critical Warnings
| check_name | status | detail | recovery_command |
| --- | --- | --- | --- |
| freshness_report | WARNING | validation report contains warning rows | .\.venv\Scripts\python.exe scripts\validate_daily_output_freshness.py --date 2026-07-26 |
| post_results_status | WARNING | post-results report missing while official picks exist | .\.venv\Scripts\python.exe scripts\run_daily_competition_controller.py --date 2026-07-26 --timezone Atlantic/Canary --mode post |
...
| today_snapshot_folder | HEALTHY | today snapshot folder present | .\.venv\Scripts\python.exe scripts\run_daily_competition_controller.py --date 2026-07-26 --timezone Atlantic/Canary --mode pre | /home/runner/work/vsigma/vsigma/data/processed/today/2026-07-26 |
| official_baseline_output | HEALTHY | present with 1 row(s) |  | /home/runner/work/vsigma/vsigma/data/processed/today/2026-07-26/vsigma_today_competition_top.csv |
| candidate_output:CANDIDATE_V2 | HEALTHY | present with 1 row(s) |  | /home/runner/work/vsigma/vsigma/data/processed/today/2026-07-26/vsigma_today_candidate_v2_competition_top.csv |
| candidate_output:CANDIDATE_V7 | HEALTHY | empty output with headers is valid for NO_BET |  | /home/runner/work/vsigma/vsigma/data/processed/today/2026-07-26/vsigma_today_candidate_v7_competition_top.csv |
| candidate_output:CANDIDATE_V7_SHORTLIST | HEALTHY | present with 1 row(s) |  | /home/runner/work/vsigma/vsigma/data/processed/today/2026-07-26/vsigma_today_candidate_v7_competition_shortlist.csv |
| candidate_output:CANDIDATE_V4 | HEALTHY | present with 1 row(s) |  | /home/runner/work/vsigma/vsigma/data/processed/today/2026-07-26/vsigma_today_candidate_v4_competition_top.csv |
| candidate_output:CANDIDATE_V5 | HEALTHY | present with 1 row(s) |  | /home/runner/work/vsigma/vsigma/data/processed/today/2026-07-26/vsigma_today_candidate_v5_competition_top.csv |
| candidate_output:CANDIDATE_V6 | HEALTHY | empty output with headers is valid for NO_BET |  | /home/runner/work/vsigma/vsigma/data/processed/today/2026-07-26/vsigma_today_candidate_v6_competition_top.csv |
| daily_master_report | HEALTHY | present |  | /home/runner/work/vsigma/vsigma/data/processed/today/2026-07-26/daily_competition_master_report.md |
...
| freshness_report | WARNING | validation report contains warning rows | .\.venv\Scripts\python.exe scripts\validate_daily_output_freshness.py --date 2026-07-26 | /home/runner/work/vsigma/vsigma/data/processed/today/2026-07-26/vsigma_daily_freshness_report.csv |
| candidate_isolation_report | HEALTHY | validation report present without ERROR |  | /home/runner/work/vsigma/vsigma/data/processed/today/2026-07-26/vsigma_candidate_isolation_report.csv |
...
| post_results_status | WARNING | post-results report missing while official picks exist | .\.venv\Scripts\python.exe scripts\run_daily_competition_controller.py --date 2026-07-26 --timezone Atlantic/Canary --mode post | /home/runner/work/vsigma/vsigma/data/processed/today_post_results_report.csv |
...
| disk_space | HEALTHY | free disk space acceptable: 86.38 GB |  |  |
