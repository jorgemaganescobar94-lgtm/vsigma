# vSIGMA Improvement Proposals - 2026-07-26

## Executive Proposal Summary
- generated_at: 2026-07-27T11:51:07+01:00
- proposals generated: 13
- proposal_type_counts: DATA_QUALITY_PROPOSAL=6; MODEL_SHADOW_PROPOSAL=5; OPERATIONAL_PROPOSAL=2
- proposal_status_counts: PROPOSAL_ONLY=7; SHADOW_CANDIDATE_REQUIRED=3; MONITOR_ONLY=3
- priority_counts: P3=5; P1=4; P2=4

## Top Proposals
- P1 | SHADOW_CANDIDATE_REQUIRED | MODEL_SHADOW_PROPOSAL | MARKET_RISK_CLUSTER | n=6 | auto_apply=NO | action=Create a shadow-only candidate for pattern OVER_1_5::FAILURE_MODE_LOW_CONVERSION; do not change production until backtest/forward-test promotion gates pass.
...
- P3 | MONITOR_ONLY | MODEL_SHADOW_PROPOSAL | ACTIONABLE_LOSS_CLUSTER | n=1 | auto_apply=NO | action=Create a shadow-only candidate for pattern AWAY_WIN; do not change production until backtest/forward-test promotion gates pass.
- P3 | MONITOR_ONLY | MODEL_SHADOW_PROPOSAL | ACTIONABLE_LOSS_CLUSTER | n=1 | auto_apply=NO | action=Create a shadow-only candidate for pattern OVER_2_5; do not change production until backtest/forward-test promotion gates pass.
