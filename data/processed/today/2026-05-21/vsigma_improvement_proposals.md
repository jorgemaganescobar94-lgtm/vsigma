...
- proposal_type_counts: DATA_QUALITY_PROPOSAL=8; MODEL_SHADOW_PROPOSAL=4; OPERATIONAL_PROPOSAL=2
- proposal_status_counts: PROPOSAL_ONLY=10; SHADOW_CANDIDATE_REQUIRED=3; MONITOR_ONLY=1
- priority_counts: P2=6; P1=5; P3=3
...
- P1 | PROPOSAL_ONLY | OPERATIONAL_PROPOSAL | EXPIRED_PRELOCK_CLUSTER | n=7 | auto_apply=NO | action=Review execution timing and exclude expired rows from predictive hit-rate metrics.
...
- P2 | PROPOSAL_ONLY | DATA_QUALITY_PROPOSAL | UNRESOLVED_DOMINANCE | n=20 | auto_apply=NO | action=Resolve UNKNOWN/UNRESOLVED/NO_SIGNAL evidence quality before creating any model shadow candidate.
- P2 | PROPOSAL_ONLY | DATA_QUALITY_PROPOSAL | MARKET_RISK_CLUSTER | n=10 | auto_apply=NO | action=Resolve UNKNOWN/UNRESOLVED/NO_SIGNAL evidence quality before creating any model shadow candidate.
...
- P2 | PROPOSAL_ONLY | DATA_QUALITY_PROPOSAL | SAMPLE_KEY_CLUSTER | n=8 | auto_apply=NO | action=Resolve UNKNOWN/UNRESOLVED/NO_SIGNAL evidence quality before creating any model shadow candidate.
- P2 | PROPOSAL_ONLY | DATA_QUALITY_PROPOSAL | MARKET_RISK_CLUSTER | n=4 | auto_apply=NO | action=Resolve UNKNOWN/UNRESOLVED/NO_SIGNAL evidence quality before creating any model shadow candidate.
