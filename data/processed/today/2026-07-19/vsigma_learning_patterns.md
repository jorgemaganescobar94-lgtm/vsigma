# vSIGMA Learning Patterns - 2026-07-19

## Executive Pattern Summary
- generated_at: 2026-07-20T11:21:01+01:00
- patterns detected: 13
- pattern_type_counts: MARKET_RISK_CLUSTER=4, SAMPLE_KEY_CLUSTER=4, ACTIONABLE_LOSS_CLUSTER=2, WAITING_PRELOCK_CLUSTER=1, UNRESOLVED_DOMINANCE=1, EXPIRED_PRELOCK_CLUSTER=1
...
- P3 | ACTIONABLE_LOSS_CLUSTER | HOME_WIN | n=1 | recommendation=Potential model-risk pattern; keep in proposal-only state until shadow/backtest evidence exists.
