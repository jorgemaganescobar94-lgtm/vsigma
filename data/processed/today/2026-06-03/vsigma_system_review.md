# vSIGMA System Review - 2026-06-03
...
- Ledger rows total: 162
- Ledger rows for target date: 0
- Decision outcome ledger rows total: 57
- Decision outcome ledger actionable rows: 8
- Decision outcome ledger non-actionable rows: 49
- Decision outcome ledger no bet rows: 30
- Decision outcome ledger expired rows: 20
- Decision outcome ledger waiting rows: 19
- Decision outcome ledger blocked rows: 10
...
- coverage rich / partial / weak: COVERAGE_PARTIAL: 1
- odds coverage: 1/1
- fixture stats coverage: 0/1
...
## Model / Market Review
- markets appearing in current/historical inputs: OVER_1_5: 124; OVER_2_5: 26; BTTS_YES: 3; UNDER_3_5: 3; AWAY_WIN: 2
- failure modes principales: FAILURE_MODE_LOW_CONVERSION: 208; LOW_CONVERSION: 104; FAILURE_MODE_AVALANCHE_RISK: 2
- OVER_1_5: appearances=124; calibration_sample=0; status=needs more sample
