# vSIGMA Daily Operator Brief - 2026-06-03
...
| Field | Value | Meaning |
|---|---|---|
| Previous | date=2026-06-03; action=UNKNOWN; risk=NONE; final=NO_OPERATOR_ACTION; active=0 | data/processed/today/2026-06-03/vsigma_operator_brief.csv |
| Current | date=2026-06-03; action=NONE; risk=NONE; final=NO_OPERATOR_ACTION; active=0 | current_build |
...
- WINDOWS_READ=UTF8 | Get-Content data/processed/today/2026-06-03/vsigma_operator_brief.md -Encoding UTF8
...
## Key Files
- data/processed/today/2026-06-03/vsigma_daily_execution_board.md
- data/processed/today/2026-06-03/vsigma_prelock_live_recheck.md
- data/processed/today/2026-06-03/vsigma_live_trigger_validator.md
- data/processed/today/2026-06-03/vsigma_automation_health.md
- data/processed/today/2026-06-03/vsigma_issue_alert_status.md
...
### Calibration Sources
- shadow_queue: data/processed/today/2026-06-03/vsigma_calibration_shadow_patch_queue.csv
- promotion_readiness: data/processed/today/2026-06-03/vsigma_shadow_patch_promotion_readiness.csv
