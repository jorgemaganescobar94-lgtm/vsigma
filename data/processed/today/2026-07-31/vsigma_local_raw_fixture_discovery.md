...
- accepted_rows: 4
- rejected_rows: 8
- source_status_counts: NO_SAME_DAY_ROWS=1984; EMPTY_OR_UNREADABLE=1483; NO_ACCEPTED_ROWS=5; HAS_ACCEPTED_ROWS=1
- next_action: Review accepted rows, then feed normal scoring gates.
- auto_apply: NO
- production_change: NO

## Accepted Rows
- IF Brommapojkarna vs Hammarby FF | fixture_id=1494217 | league=Allsvenskan | source=data/processed/governance/vsigma_match_stat_forecasts.csv
- KFUM Oslo vs Molde | fixture_id=1494711 | league=Eliteserien | source=data/processed/governance/vsigma_match_stat_forecasts.csv
- Remo vs Vitoria | fixture_id=1492307 | league=Serie A | source=data/processed/governance/vsigma_match_stat_forecasts.csv
- Aalesund vs Viking | fixture_id=1494709 | league=Eliteserien | source=data/processed/governance/vsigma_match_stat_forecasts.csv
...
- data/processed/governance/vsigma_api_enriched_fixture_results_refresh.csv | status=NO_SAME_DAY_ROWS | rows=4 | same_day=0 | accepted=0 | rejected=0 | detail=file has no target-date rows
- data/processed/governance/vsigma_api_enriched_scored_candidates.csv | status=NO_SAME_DAY_ROWS | rows=4 | same_day=0 | accepted=0 | rejected=0 | detail=file has no target-date rows
...
- data/processed/governance/vsigma_local_raw_fixture_discovery_candidates.csv | status=NO_SAME_DAY_ROWS | rows=4 | same_day=0 | accepted=0 | rejected=0 | detail=file has no target-date rows
...
- data/processed/governance/vsigma_match_stat_forecasts.csv | status=HAS_ACCEPTED_ROWS | rows=4 | same_day=4 | accepted=4 | rejected=0 | detail=local source contains accepted raw fixture rows
...
- data/processed/governance/vsigma_promoted_api_enriched_candidates.csv | status=NO_SAME_DAY_ROWS | rows=4 | same_day=0 | accepted=0 | rejected=0 | detail=file has no target-date rows
...
- data/processed/governance/vsigma_raw_candidate_trust_gate.csv | status=NO_SAME_DAY_ROWS | rows=4 | same_day=0 | accepted=0 | rejected=0 | detail=file has no target-date rows
...
- data/processed/governance/vsigma_trusted_raw_candidate_promotion_gate.csv | status=NO_SAME_DAY_ROWS | rows=4 | same_day=0 | accepted=0 | rejected=0 | detail=file has no target-date rows
- data/processed/governance/vsigma_trusted_raw_fixture_candidates.csv | status=NO_SAME_DAY_ROWS | rows=4 | same_day=0 | accepted=0 | rejected=0 | detail=file has no target-date rows
