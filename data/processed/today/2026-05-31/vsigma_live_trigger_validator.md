...
## Rows
- #1 | window=TOO_LATE | decision=TOO_LATE | Cordoba vs Huesca | market=OVER_1_5_SUPPORTED | status=2H | min=81.0 | mtko=633.49 | score=1-0 | shots=0 | SoT=0 | corners=0 | signal=0 | reason=live window passed
...
- #4 | window=TOO_LATE | decision=TOO_LATE | Vasco DA Gama vs Atletico-MG | market=BTTS_YES_REVIEW | status=2H | min=80.0 | mtko=633.42 | score=0-1 | shots=0 | SoT=0 | corners=0 | signal=0 | reason=live window passed
