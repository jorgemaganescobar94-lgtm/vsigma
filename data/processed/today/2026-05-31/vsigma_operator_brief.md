...
| Field | Value | Meaning |
|---|---|---|
| Previous | date=2026-05-31; action=UNKNOWN; risk=NONE; final=NO_OPERATOR_ACTION; active=0 | data/processed/today/2026-05-31/vsigma_operator_brief.csv |
| Current | date=2026-05-31; action=BROKEN; risk=HIGH; final=SYSTEM_FIX_REQUIRED; active=0 | current_build |
