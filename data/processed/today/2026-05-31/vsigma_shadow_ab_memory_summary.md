# vSIGMA Shadow A/B Historical Memory - 2026-05-31
...
## Metric Memory
- ALL | verdict=MEMORY_WAIT_MORE_DATA | latest=NO_DATA | days=1 | usable=0 | bad=0 | blocked=0 | delta_mean=0.000 | reason=Recent history has low sample or no-data days.
