# vSIGMA API-Enriched Manual Review Inspector - 2026-08-13
...
## Inspector Rows
- #1 | RB Bragantino vs Atletico-MG | priority=P1_MANUAL_REVIEW | signal_score=82 | signal_band=HIGH_SIGNAL_REVIEW | bucket=P1_REVIEW_STRONG_SIGNAL | risk=MEDIUM | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION | reason=Strong API-enriched review signal. Human review may inspect first, but no promotion is allowed.
