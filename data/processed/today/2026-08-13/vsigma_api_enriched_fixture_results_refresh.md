# vSIGMA API-Enriched Fixture Results Refresh - 2026-08-13
...
## Result Rows
- RB Bragantino vs Atletico-MG | status=FT | score=0-1 | ready=YES | provider=API-SPORTS_DIRECT | note=fixture fetched
