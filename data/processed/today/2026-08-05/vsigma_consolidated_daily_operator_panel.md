# vSIGMA Consolidated Daily Operator Panel - 2026-08-05
...
## No Bet
- #1 | NO_BET | Dundee Utd vs Rangers | market=NO_CLEAR_STAT_MARKET | stake=NO_STAKE | permission=NO | conf=LOW | score=-34
...
- source: data/processed/today/2026-08-05/vsigma_api_enriched_review_board.csv
...
### API Review Rows
- P1_MANUAL_REVIEW | Dundee Utd vs Rangers | status=API_ENRICHED_REVIEW_READY | score=100 | canonical=NO_CANONICAL_BOARD_PERMISSION | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION | summary=prediction_winner=Rangers | pred_total_home_away=25.5/74.5 | 1x2=5.00/3.90/1.64 | ou2.5=3.40/1.28
...
- data/processed/today/2026-08-05/official_lineup_sources.csv: rows=286
- data/processed/today/2026-08-05/vsigma_probable_lineup_consensus.csv: rows=1
- data/processed/governance/official_lineup_sources.csv: rows=286
...
- .vsigma/triggers/daily_chain_self_heal.trigger: date=2026-08-05; reason=normalize_daily_chain_self_heal_date; triggered_at=2026-08-05T11:07:41+01:00
- .vsigma/triggers/daily_decision_chain_v2.trigger: date=2026-08-05; reason=normalize_daily_decision_chain_v2_date; triggered_at=2026-08-05T11:07:41+01:00
- .vsigma/triggers/prelock_official_lineup_recheck.trigger: date=2026-08-05; reason=normalize_prelock_recheck_date; triggered_at=2026-08-05T11:07:41+01:00

## Key Files
- data/processed/today/2026-08-05/vsigma_consolidated_daily_operator_panel.md
- data/processed/today/2026-08-05/vsigma_operator_brief.md
- data/processed/today/2026-08-05/vsigma_daily_execution_board.md
- data/processed/today/2026-08-05/vsigma_prelock_live_recheck.md
- data/processed/today/2026-08-05/vsigma_live_trigger_validator.md
- data/processed/today/2026-08-05/vsigma_automation_health.md
- data/processed/today/2026-08-05/vsigma_probable_lineup_source_reliability_governor.md
...
- trigger_date_counts: 2026-08-05=2
...
- quarantine_rows: 0
- blocked_rows: 0
- trust_status_counts: TRUSTED_RAW_SOURCE=1
...
- p1_rows: 1
- p2_rows: 0
- p1_estimated_units: 5
- p2_estimated_units: 0
- auto_units_reserved: 5
- max_auto_units_per_day: 5000
- max_auto_units_per_run: 1500
- quota_decision_counts: AUTO_ENRICHMENT_ALLOWED_P1=1
...
- rows_reviewed: 1
- rows_allowed: 1
- full_scoring_enrichment_rows: 1
- coverage_probe_rows: 0
- diagnostic_only_rows: 0
- blocked_rows: 0
- estimated_call_units: 5
- downstream_use_counts: SCORING_ALLOWED_WITH_NORMAL_GATES=1
...
- pending_rows: 354
- summary_rows: 84
- top_market_by_hit_rate: SCORE_BUCKET=SCORE_90_PLUS | API_DOUBLE_CHANCE | hit_rate_pct=86.7 | evaluated=120
- top_market_by_hit_or_void_rate: SCORE_BUCKET=SCORE_90_PLUS | API_DNB | hit_or_void_rate_pct=86.7 | evaluated=120
...
- shadow_rows: 16
- finished_shadow_rows: 16
- pending_shadow_rows: 0
- shadow_outcome_counts: HIT=11; VOID=5
- rule_market_counts: API_DNB=5; API_DOUBLE_CHANCE=5; OVER_1_5=5; UNDER_3_5=1
- paper_trade_permission_counts: SHADOW_ONLY=16
