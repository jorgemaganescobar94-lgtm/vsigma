# vSIGMA API-Enriched Fixture Results Refresh - 2026-08-11
...
## Result Rows
- Vasteras SK FK vs Djurgardens IF | status=FT | score=1-0 | ready=YES | provider=API-SPORTS_DIRECT | note=fixture fetched
