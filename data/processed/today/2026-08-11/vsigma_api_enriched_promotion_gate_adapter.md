# vSIGMA API-Enriched Promotion Gate Adapter - 2026-08-11
...
## Adapter Rows
- Vasteras SK FK vs Djurgardens IF | adapter=API_ENRICHED_PROMOTION_REVIEW_READY | allowed=SCORING_REVIEW_ONLY_WITH_NORMAL_GATES | score=100 | summary=prediction_winner=Djurgardens IF | pred_total_home_away=26.7/73.3 | 1x2=4.60/3.95/1.67 | ou2.5=1.55/2.45 | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION
