# vSIGMA Promotion Input Bridge - 2026-08-11
...
## Bridge Rows
- Vasteras SK FK vs Djurgardens IF | bridge=PROMOTION_INPUT_READY_REVIEW_ONLY | score=100 band=HIGH_SIGNAL_REVIEW | summary=prediction_winner=Djurgardens IF | pred_total_home_away=26.7/73.3 | 1x2=4.60/3.95/1.67 | ou2.5=1.55/2.45 | promotion=REVIEW_ONLY_PROMOTION_INPUT | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION
