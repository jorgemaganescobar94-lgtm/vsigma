# vSIGMA API-Enriched Review Board - 2026-08-11
...
## Review Rows
- P1_MANUAL_REVIEW | Vasteras SK FK vs Djurgardens IF | status=API_ENRICHED_REVIEW_READY | score=100 | summary=prediction_winner=Djurgardens IF | pred_total_home_away=26.7/73.3 | 1x2=4.60/3.95/1.67 | ou2.5=1.55/2.45 | canonical=NO_CANONICAL_BOARD_PERMISSION | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION
