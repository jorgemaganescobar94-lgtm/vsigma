# vSIGMA Max-Coverage API Enrichment Executor - 2026-08-11
...
## Executor Rows
- Vasteras SK FK vs Djurgardens IF | downstream=SCORING_ALLOWED_WITH_NORMAL_GATES | mode=EXECUTE_API_CALLS | status=EXECUTED_WITH_DATA | success=fixture_detail;statistics;events;lineups;predictions;odds | failed=none | scoring_after=YES_PENDING_NORMAL_GATES
