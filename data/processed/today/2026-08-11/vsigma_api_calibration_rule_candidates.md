# vSIGMA API Calibration Rule Candidates - 2026-08-11
...
## Candidate Rules
- API_CAL_RULE_0002 | ALL=ALL | API_DNB | evaluated=340 | hit=53.5 | hit_or_void=77.4 | miss=22.6 | decision=FUTURE_RULE_REVIEW_ONLY | permission=NO_RULE_ACTIVATION_PERMISSION | reason=API DNB hit_or_void=77.4% and miss_rate=22.6% meet protected-market threshold.
- API_CAL_RULE_0003 | ALL=ALL | API_DOUBLE_CHANCE | evaluated=340 | hit=77.4 | hit_or_void=77.4 | miss=22.6 | decision=FUTURE_RULE_REVIEW_ONLY | permission=NO_RULE_ACTIVATION_PERMISSION | reason=API double chance hit_rate=77.4% meets protected-market threshold.
- API_CAL_RULE_0005 | ALL=ALL | OVER_1_5 | evaluated=341 | hit=76.5 | hit_or_void=76.5 | miss=23.5 | decision=FUTURE_RULE_REVIEW_ONLY | permission=NO_RULE_ACTIVATION_PERMISSION | reason=Over 1.5 hit_rate=76.5% meets total-market threshold.
- API_CAL_RULE_0009 | PREDICTED_SIDE=AWAY | API_DNB | evaluated=176 | hit=49.4 | hit_or_void=77.8 | miss=22.2 | decision=FUTURE_RULE_REVIEW_ONLY | permission=NO_RULE_ACTIVATION_PERMISSION | reason=API DNB hit_or_void=77.8% and miss_rate=22.2% meet protected-market threshold.
- API_CAL_RULE_0010 | PREDICTED_SIDE=AWAY | API_DOUBLE_CHANCE | evaluated=176 | hit=77.8 | hit_or_void=77.8 | miss=22.2 | decision=FUTURE_RULE_REVIEW_ONLY | permission=NO_RULE_ACTIVATION_PERMISSION | reason=API double chance hit_rate=77.8% meets protected-market threshold.
- API_CAL_RULE_0012 | PREDICTED_SIDE=AWAY | OVER_1_5 | evaluated=176 | hit=81.8 | hit_or_void=81.8 | miss=18.2 | decision=FUTURE_RULE_REVIEW_ONLY | permission=NO_RULE_ACTIVATION_PERMISSION | reason=Over 1.5 hit_rate=81.8% meets total-market threshold.
...
## Block Rules
- API_CAL_RULE_0001 | ALL=ALL | API_1X2 | evaluated=340 | hit=53.5 | miss=46.5 | decision=BLOCK_ML_PROMOTION | reason=API 1X2 hit_rate=53.5% is below the 60% minimum for any ML review.
- API_CAL_RULE_0006 | ALL=ALL | OVER_2_5 | evaluated=341 | hit=53.4 | miss=46.6 | decision=BLOCK_OVER_2_5_PROMOTION | reason=OVER_2_5 hit_rate=53.4% is weak/negative in current calibration.
- API_CAL_RULE_0008 | PREDICTED_SIDE=AWAY | API_1X2 | evaluated=176 | hit=49.4 | miss=50.6 | decision=BLOCK_ML_PROMOTION | reason=API 1X2 hit_rate=49.4% is below the 60% minimum for any ML review.
