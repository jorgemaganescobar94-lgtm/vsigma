# vSIGMA Candidate Provenance Ledger - 2026-08-11
...
## Candidate Rows
- Vasteras SK FK vs Djurgardens IF | origin=OBJECTIVE_PROXY | market=NO_CLEAR_STAT_MARKET | direction=UNKNOWN | max_permission=NO_BET | strength=21 | allowed=DIAGNOSTIC_ONLY_NO_MARKET_PERMISSION | reason=objective context bridge created diagnostic shortlist row
