# vSIGMA API-Enriched Scored Candidates - 2026-08-11
...
## Candidate Rows
- Vasteras SK FK vs Djurgardens IF | status=API_ENRICHED_SCORING_READY_PENDING_GATES | fixture=YES pred=YES odds=YES | summary=prediction_winner=Djurgardens IF | pred_total_home_away=26.7/73.3 | 1x2=4.60/3.95/1.67 | ou2.5=1.55/2.45 | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION
