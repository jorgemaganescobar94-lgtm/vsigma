...
- Decision outcome ledger rows total: 73
- Decision outcome ledger actionable rows: 8
- Decision outcome ledger non-actionable rows: 65
- Decision outcome ledger no bet rows: 41
- Decision outcome ledger expired rows: 24
- Decision outcome ledger waiting rows: 24
- Decision outcome ledger blocked rows: 17
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1551271 | Segunda División | Malaga | Almeria | OVER_2_5 | NO_BET | NO | PRELOCK_GOVERNANCE_NOT_RETAINED | NO |  |  | PRELOCK_NOT_RETAINED |  | IN_WINDOW_BUT_NOT_RETAINED |  |
