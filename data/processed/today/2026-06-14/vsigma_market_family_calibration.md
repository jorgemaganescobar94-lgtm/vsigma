# vSIGMA Market Family Calibration - 2026-06-14
...
- TOTAL_GOALS | real=0/2 | green=0 red=0 void=0 | gate=INSUFFICIENT_SAMPLE | status=HOLD_SAMPLE | signal=NO_WEIGHT_CHANGE | action=Collect more market-family samples before changing confidence.
