# vSIGMA Pattern Promotion Readiness - 2026-08-19

## Executive Readiness Summary
- generated_at: 2026-08-19T02:49:05+01:00
...
- #8 | BLOCKED_BY_DATA_QUALITY | key=OVER_2_5::UNKNOWN_RISK | sample=3 | closed=0 | next=RESOLVE_DATA_QUALITY_FIRST | reason=P1/P2 data-quality issues block model promotion and threshold/calibration changes.
- #9 | BLOCKED_BY_DATA_QUALITY | key=UNRESOLVED::OVER_2_5::UNKNOWN_RISK::NO_SIGNAL | sample=3 | closed=0 | next=RESOLVE_DATA_QUALITY_FIRST | reason=P1/P2 data-quality issues block model promotion and threshold/calibration changes.
- #10 | BLOCKED_BY_DATA_QUALITY | key=WAITING_PRELOCK::OVER_1_5::FAILURE_MODE_LOW_CONVERSION::WAIT_FOR_POST_RESULTS | sample=3 | closed=0 | next=RESOLVE_DATA_QUALITY_FIRST | reason=P1/P2 data-quality issues block model promotion and threshold/calibration changes.
