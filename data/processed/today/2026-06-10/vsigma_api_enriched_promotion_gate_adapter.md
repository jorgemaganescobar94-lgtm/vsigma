...
- adapter_rows_written: 93
- adapter_promoted_review_only_rows: 32
- adapter_blocked_rows: 61
- adapter_status_counts: ADAPTER_BLOCKED_NOT_READY=38; API_ENRICHED_PROMOTION_REVIEW_READY=32; ADAPTER_BLOCKED_WEAK_SIGNAL=23
- allowed_downstream_use_counts: NO_DOWNSTREAM_USE=61; SCORING_REVIEW_ONLY_WITH_NORMAL_GATES=32
...
- Fjardabyggd / Leiknir vs Fjolnir | adapter=API_ENRICHED_PROMOTION_REVIEW_READY | allowed=SCORING_REVIEW_ONLY_WITH_NORMAL_GATES | score=61 | summary=prediction_winner=Fjardabyggd / Leiknir | pred_total_home_away=55.5/44.5 | 1x2=2.25/3.95/2.38 | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION
- Haukar vs Kormákur / Hvöt | adapter=API_ENRICHED_PROMOTION_REVIEW_READY | allowed=SCORING_REVIEW_ONLY_WITH_NORMAL_GATES | score=84 | summary=prediction_winner=Haukar | pred_total_home_away=63.2/36.8 | 1x2=1.44/4.33/5.40 | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION
...
- Thróttur Vogar vs Vikingur Olafsiik | adapter=API_ENRICHED_PROMOTION_REVIEW_READY | allowed=SCORING_REVIEW_ONLY_WITH_NORMAL_GATES | score=71 | summary=prediction_winner=Thróttur Vogar | pred_total_home_away=58.8/41.2 | 1x2=1.73/3.90/3.55 | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION
...
- Brasil DE Pelotas vs Farroupilha | adapter=API_ENRICHED_PROMOTION_REVIEW_READY | allowed=SCORING_REVIEW_ONLY_WITH_NORMAL_GATES | score=100 | summary=prediction_winner=Brasil DE Pelotas | pred_total_home_away=74.3/25.7 | 1x2=1.25/5.10/9.50 | ou2.5=1.70/2.05 | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION
...
- Gualaceo SC vs Cumbayá | adapter=API_ENRICHED_PROMOTION_REVIEW_READY | allowed=SCORING_REVIEW_ONLY_WITH_NORMAL_GATES | score=69 | summary=prediction_winner=Cumbayá | pred_total_home_away=45.3/54.7 | 1x2=2.15/2.90/3.20 | ou2.5=2.25/1.50 | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION
- Ind. Juniors vs Deportivo Cuenca Juniors | adapter=API_ENRICHED_PROMOTION_REVIEW_READY | allowed=SCORING_REVIEW_ONLY_WITH_NORMAL_GATES | score=64 | summary=prediction_winner=Deportivo Cuenca Juniors | pred_total_home_away=47.0/53.0 | 1x2=1.90/3.10/3.70 | ou2.5=2.25/1.50 | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION
...
- Asiagoal vs Toktogul | adapter=ADAPTER_BLOCKED_WEAK_SIGNAL | allowed=NO_DOWNSTREAM_USE | score=44 | summary=prediction_winner=Asiagoal | pred_total_home_away=43.5/56.5 | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION
...
- Afrique Football Élite vs ASKO | adapter=API_ENRICHED_PROMOTION_REVIEW_READY | allowed=SCORING_REVIEW_ONLY_WITH_NORMAL_GATES | score=90 | summary=prediction_winner=ASKO | pred_total_home_away=31.7/68.3 | 1x2=1.95/2.85/4.00 | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION
...
- Shortan vs Gazalkent | adapter=API_ENRICHED_PROMOTION_REVIEW_READY | allowed=SCORING_REVIEW_ONLY_WITH_NORMAL_GATES | score=93 | summary=prediction_winner=Shortan | pred_total_home_away=62.8/37.3 | 1x2=1.91/3.30/3.40 | ou2.5=1.75/1.85 | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION
...
- Excelsior Maassluis vs Ijsselmeervogels | adapter=API_ENRICHED_PROMOTION_REVIEW_READY | allowed=SCORING_REVIEW_ONLY_WITH_NORMAL_GATES | score=56 | summary=prediction_winner=Ijsselmeervogels | pred_total_home_away=46.3/53.7 | 1x2=2.10/3.50/2.80 | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION
