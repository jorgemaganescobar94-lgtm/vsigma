...
## Summary
- goal_timing_rows: 6
- goal_timing_data_status_counts: NO_GOAL_TIMING_DATA=6
- goal_timing_profile_counts: GOAL_TIMING_DATA_MISSING=5; DIAGNOSTIC_NO_GOAL_TIMING_LEARNING=1
- goal_timing_learning_label_counts: NO_TIMING_SIGNAL=5; DIAGNOSTIC_NOT_REAL_FIXTURE=1
- timing_evidence_level_counts: LOW=5; NONE=1
...
- GOAL_TIMING_DATA_MISSING | Almeria vs Castellón | first_goal=NA team=UNKNOWN | 0-0HT=UNKNOWN early15=NO late75=0 | outcome=PENDING | label=NO_TIMING_SIGNAL | manual=NO | action=COLLECT_GOAL_EVENT_DATA
- GOAL_TIMING_DATA_MISSING | Nautico Recife vs Fortaleza EC | first_goal=NA team=UNKNOWN | 0-0HT=UNKNOWN early15=NO late75=0 | outcome=PENDING | label=NO_TIMING_SIGNAL | manual=NO | action=COLLECT_GOAL_EVENT_DATA
- GOAL_TIMING_DATA_MISSING | Ponte Preta vs Cuiaba | first_goal=NA team=UNKNOWN | 0-0HT=UNKNOWN early15=NO late75=0 | outcome=PENDING | label=NO_TIMING_SIGNAL | manual=NO | action=COLLECT_GOAL_EVENT_DATA
