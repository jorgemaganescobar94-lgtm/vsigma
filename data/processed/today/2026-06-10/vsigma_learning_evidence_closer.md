# vSIGMA Learning Evidence Closer - 2026-06-10

## Executive Evidence Summary
- generated_at: 2026-06-10T13:44:28+01:00
- executive_status: POST_RESULT_LABELING_REQUIRED
- close_items: 7
- severity_counts: P2=4; P3=3
- issue_counts: OPEN_RESULT_STATUS=2; MISSING_IDENTITY=1; PRELOCK_OPEN_ITEM=1; NO_SIGNAL=1; UNKNOWN_FAMILY=1; UNKNOWN_RISK=1
- auto_fix: NO
...
- #3 | P2 | OPEN_RESULT_STATUS | fixture=1548055 | market=OVER_1_5 | field=result_status | state=WAIT_POST_RESULT_LABELING | next=RUN_POST_THEN_REBUILD_LEARNING | reason=Outcome cannot close until post-result labeling is available.
- #4 | P2 | PRELOCK_OPEN_ITEM | fixture=1548055 | market=OVER_1_5 | field=lineup_activation_state | state=WAIT_PRELOCK | next=RUN_PRELOCK_IN_WINDOW | reason=BET row still needs prelock/lineup timing confirmation.
