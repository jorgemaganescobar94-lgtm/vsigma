...
- dated_scored_matches | status=HAS_ROWS | same_day=1 | real=0 | proxy=0 | bet_like=0 | path=data/processed/today/2026-06-10/matches_vsigma_scored_v3.csv | detail=file has same-day rows
