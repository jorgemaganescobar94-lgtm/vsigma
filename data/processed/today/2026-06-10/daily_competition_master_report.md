...
| 1548055 | Malaga | Las Palmas | OVER_1_5 | OFFICIAL_BASELINE | 1.37 | 1.37 | 1.37 | 0.0 | CLV_FLAT | WIN | 0.37 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| OFFICIAL_EXECUTION_SHORTLIST | 1.0 | 1.0 | 0.0 | 0.37 | 37.0 | 0.0 | OFFICIAL_RESULTS |
...
- Recovery command: `.\.venv\Scripts\python.exe scripts\update_immutable_daily_ledger.py --date 2026-06-11 --stage PRE`
