# vSIGMA Local Raw Fixture Discovery - 2026-07-12
...
- accepted_rows: 2
- rejected_rows: 4
- source_status_counts: NO_SAME_DAY_ROWS=1726; EMPTY_OR_UNREADABLE=1280; NO_ACCEPTED_ROWS=3; HAS_ACCEPTED_ROWS=1
- next_action: Review accepted rows, then feed normal scoring gates.
- auto_apply: NO
- production_change: NO

## Accepted Rows
- Ulsan Hyundai FC vs Jeonbuk Motors | fixture_id=1506994 | league=K League 1 | source=data/processed/governance/vsigma_match_stat_forecasts.csv
- Gwangju FC vs Pohang Steelers | fixture_id=1506993 | league=K League 1 | source=data/processed/governance/vsigma_match_stat_forecasts.csv
...
- data/processed/governance/vsigma_local_raw_fixture_discovery_candidates.csv | status=NO_SAME_DAY_ROWS | rows=514 | same_day=0 | accepted=0 | rejected=0 | detail=file has no target-date rows
...
- data/processed/governance/vsigma_promoted_raw_fixture_candidates.csv | status=NO_SAME_DAY_ROWS | rows=8 | same_day=0 | accepted=0 | rejected=0 | detail=file has no target-date rows
- data/processed/governance/vsigma_raw_candidate_trust_gate.csv | status=NO_SAME_DAY_ROWS | rows=514 | same_day=0 | accepted=0 | rejected=0 | detail=file has no target-date rows
...
- data/processed/governance/vsigma_trusted_raw_candidate_promotion_gate.csv | status=NO_SAME_DAY_ROWS | rows=514 | same_day=0 | accepted=0 | rejected=0 | detail=file has no target-date rows
- data/processed/governance/vsigma_trusted_raw_fixture_candidates.csv | status=NO_SAME_DAY_ROWS | rows=470 | same_day=0 | accepted=0 | rejected=0 | detail=file has no target-date rows
