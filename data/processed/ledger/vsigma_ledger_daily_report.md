# vSIGMA Immutable Ledger Daily Report - 2026-07-26
...
- Pending records: 0
- Settled records: 4
- Daily winner: CANDIDATE_V4_O25_FIREWALL
...
| --- | --- | --- | --- | --- | --- | --- |
| CANDIDATE_V2_SCHEDULE_ANOMALY | 1 | 1 | 0 | 0 | 1 | -1.0 |
| CANDIDATE_V3_ODDS_DEPTH | 1 | 0 | 1 | 0 | 0 | 0.0 |
| CANDIDATE_V4_O25_FIREWALL | 1 | 1 | 0 | 0 | 1 | 0.17 |
| CANDIDATE_V5_PLAYER_IMPACT | 1 | 1 | 0 | 0 | 1 | -1.0 |
| CANDIDATE_V6_API_PREDICTIONS | 1 | 0 | 1 | 0 | 0 | 0.0 |
| CANDIDATE_V7_PRICE_DISCIPLINE | 1 | 0 | 1 | 0 | 0 | 0.0 |
| OFFICIAL_BASELINE | 1 | 1 | 0 | 0 | 1 | -1.0 |

## Official Picks
| experiment_id | rank | fixture_id | home_team | away_team | market_primary | calibrated_probability | risk_tags | record_status |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| OFFICIAL_BASELINE | 1 | 1494217 | IF Brommapojkarna | Hammarby FF | OVER_2_5 | 0.826925 | FAILURE_MODE_LOW_CONVERSION; FAILURE_MODE_LOW_CONVERSION; market=OVER_2_5; edge=0.143; market_fit=SAFE_OK; LOW_CONVERSION | SETTLED |

## Shadow Picks
| experiment_id | rank | fixture_id | home_team | away_team | market_primary | calibrated_probability | risk_tags | record_status |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| CANDIDATE_V2_SCHEDULE_ANOMALY | 1 | 1494217 | IF Brommapojkarna | Hammarby FF | OVER_2_5 | 0.814625 | FAILURE_MODE_LOW_CONVERSION; FAILURE_MODE_LOW_CONVERSION; market=OVER_2_5; edge=0.131; market_fit=SAFE_OK; LOW_CONVERSION | SETTLED |
| CANDIDATE_V4_O25_FIREWALL | 1 | 1494217 | IF Brommapojkarna | Hammarby FF | OVER_1_5 | 0.85836 | FAILURE_MODE_LOW_CONVERSION; FAILURE_MODE_LOW_CONVERSION; market=OVER_2_5; edge=0.131; market_fit=SAFE_OK; LOW_CONVERSION | SETTLED |
| CANDIDATE_V5_PLAYER_IMPACT | 1 | 1494217 | IF Brommapojkarna | Hammarby FF | OVER_2_5 | 0.814625 | FAILURE_MODE_LOW_CONVERSION; FAILURE_MODE_LOW_CONVERSION; market=OVER_2_5; edge=0.131; market_fit=SAFE_OK; LOW_CONVERSION | SETTLED |
...
| --- | --- | --- | --- | --- | --- | --- |
| OFFICIAL_BASELINE | 1494217 | OVER_2_5 | RESULT_AVAILABLE | LOSS | -1.0 | SETTLED |
| CANDIDATE_V2_SCHEDULE_ANOMALY | 1494217 | OVER_2_5 | RESULT_AVAILABLE | LOSS | -1.0 | SETTLED |
| CANDIDATE_V4_O25_FIREWALL | 1494217 | OVER_1_5 | RESULT_AVAILABLE | WIN | 0.17 | SETTLED |
| CANDIDATE_V5_PLAYER_IMPACT | 1494217 | OVER_2_5 | RESULT_AVAILABLE | LOSS | -1.0 | SETTLED |
