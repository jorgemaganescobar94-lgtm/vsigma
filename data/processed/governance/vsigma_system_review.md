...
- Decision outcome ledger rows total: 68
- Decision outcome ledger actionable rows: 8
- Decision outcome ledger non-actionable rows: 60
- Decision outcome ledger no bet rows: 37
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1548055 | Segunda División | Malaga | Las Palmas | OVER_1_5 | NO_BET | NO | KICKOFF_ALREADY_PASSED | NO |  |  | EXPIRED |  | PRELOCK_NOT_AVAILABLE |  |

## Data Coverage Review
- coverage rich / partial / weak: COVERAGE_RICH: 1
- odds coverage: 1/1
- fixture stats coverage: 1/1
- injuries coverage: 1/1
...
## Model / Market Review
- markets appearing in current/historical inputs: OVER_1_5: 139; OVER_2_5: 26; BTTS_YES: 3; UNDER_3_5: 3; AWAY_WIN: 2
- failure modes principales: FAILURE_MODE_LOW_CONVERSION: 220; LOW_CONVERSION: 110; FAILURE_MODE_AVALANCHE_RISK: 2
- OVER_1_5: appearances=139; calibration_sample=7; status=needs more sample
...
## Input Inventory
- generated_at: 2026-06-10T20:58:31+01:00
