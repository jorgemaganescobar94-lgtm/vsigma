# vSIGMA System Review - 2026-06-12
...
- Decision outcome ledger rows total: 70
- Decision outcome ledger actionable rows: 8
- Decision outcome ledger non-actionable rows: 62
- Decision outcome ledger no bet rows: 39
- Decision outcome ledger expired rows: 24
- Decision outcome ledger waiting rows: 23
- Decision outcome ledger blocked rows: 15
