# vSIGMA System Review - 2026-06-17
...
- Ledger rows total: 204
- Ledger rows for target date: 7
- Decision outcome ledger rows total: 76
- Decision outcome ledger actionable rows: 8
- Decision outcome ledger non-actionable rows: 68
- Decision outcome ledger no bet rows: 44
- Decision outcome ledger expired rows: 25
- Decision outcome ledger waiting rows: 24
- Decision outcome ledger blocked rows: 19
