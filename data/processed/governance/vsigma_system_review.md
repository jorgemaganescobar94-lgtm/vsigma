# vSIGMA System Review - 2026-05-26
...
- Ledger rows total: 117
- Ledger rows for target date: 7
- Decision outcome ledger rows total: 37
- Decision outcome ledger actionable rows: 6
- Decision outcome ledger non-actionable rows: 31
- Decision outcome ledger no bet rows: 17
- Decision outcome ledger expired rows: 14
- Decision outcome ledger waiting rows: 14
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1535324 | CONMEBOL Libertadores | LDU de Quito | Always Ready | UNDER_3_5 | WAIT | NO | OUTSIDE_PRELOCK_WINDOW | YES | 2026-05-26T22:00+01:00 |  | WAITING_FOR_WINDOW |  | OUTSIDE_90_MIN_PRELOCK_WINDOW |  |
...
- odds structure depth: target_fixtures: 6; OK: 6; RICH_MIXED: 6; MILD_GOALS: 3; BROAD_GOALS: 2
- API gaps detected: injuries

## Model / Market Review
- markets appearing in current/historical inputs: OVER_1_5: 92; OVER_2_5: 18; UNDER_3_5: 4; BTTS_YES: 3; AWAY_WIN: 2
- failure modes principales: FAILURE_MODE_LOW_CONVERSION: 144; LOW_CONVERSION: 72; FAILURE_MODE_AVALANCHE_RISK: 2
- OVER_1_5: appearances=92; calibration_sample=7; status=needs more sample
