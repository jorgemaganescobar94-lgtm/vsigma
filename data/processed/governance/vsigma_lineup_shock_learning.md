...
## Summary
- lineup_rows: 8
- lineup_data_status_counts: NO_LINEUP_DATA=4; HAS_LINEUP_DATA=4
- lineup_shock_status_counts: LINEUP_DATA_MISSING=3; OFFICIAL_LINEUP_AVAILABLE_NO_BET_REVIEW=3; DIAGNOSTIC_NO_LINEUP_LEARNING=1; OFFICIAL_LINEUP_AVAILABLE_NEUTRAL=1
- lineup_learning_label_counts: NO_LINEUP_SIGNAL=3; NO_BET_LINEUP_REVIEW=3; DIAGNOSTIC_NOT_REAL_FIXTURE=1; LINEUP_CONTEXT_PRESENT=1
- shock_evidence_level_counts: LOW=4; MEDIUM=3; NONE=1
- manual_review_required_counts: NO=5; YES=3
- auto_apply: NO
...
- LINEUP_DATA_MISSING | Malaga vs Las Palmas | official=0 probable=0 | outcome=PENDING | label=NO_LINEUP_SIGNAL | evidence=LOW | manual=NO | action=COLLECT_LINEUP_DATA
- LINEUP_DATA_MISSING | Cape Town City vs Magesi | official=0 probable=0 | outcome=NO_PICK | label=NO_LINEUP_SIGNAL | evidence=LOW | manual=NO | action=COLLECT_LINEUP_DATA
