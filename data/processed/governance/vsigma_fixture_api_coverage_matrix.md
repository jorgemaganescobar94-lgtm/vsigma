...
- standings_coverage: NONE=2; PARTIAL=1
- odds_coverage: NONE=3
- auto_apply: NO
- production_change: NO

## Fixture Coverage
- Almeria vs Castellón | gate=LOW_COVERAGE_NO_BET | score=62.5 | lineups=NOT_DUE_YET | probable=NO_PROBABLE_LINEUP_SOURCES | stats=FULL | injuries=NONE | odds=NONE | missing=lineup_coverage=NOT_DUE_YET; injuries_coverage=NONE; standings_coverage=PARTIAL; odds_coverage=NONE
