...
- dated_scored_matches | status=EMPTY | same_day=0 | real=0 | proxy=0 | bet_like=0 | path=data/processed/today/2026-06-09/matches_vsigma_scored_v3.csv | detail=file exists but has no data rows
