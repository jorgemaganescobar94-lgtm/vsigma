...
- dated_scored_matches | status=MISSING | same_day=0 | real=0 | proxy=0 | bet_like=0 | path=data/processed/today/2026-06-01/matches_vsigma_scored_v3.csv | detail=file is not present
...
- candidate_provenance_ledger | status=HAS_ROWS | same_day=4 | real=0 | proxy=4 | bet_like=0 | path=data/processed/today/2026-06-01/vsigma_candidate_provenance_ledger.csv | detail=file has same-day rows
