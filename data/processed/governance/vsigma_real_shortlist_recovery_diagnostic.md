# vSIGMA Real Shortlist Recovery Diagnostic - 2026-06-25
...
- candidate_provenance_ledger | status=EMPTY | same_day=0 | real=0 | proxy=0 | bet_like=0 | path=data/processed/today/2026-06-25/vsigma_candidate_provenance_ledger.csv | detail=file exists but has no data rows
