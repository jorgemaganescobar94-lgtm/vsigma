...
- quarantine_rows: 10
- blocked_rows: 9
- trust_status_counts: TRUSTED_RAW_SOURCE=52; QUARANTINE_REVIEW=10; REJECTED_SOURCE_BLOCK=9
...
- blocked_rows: 3
- quarantine_rows: 49
- promotion_status_counts: TRUSTED_SOURCE_BUT_NO_SCORED_ROW=49; NOT_TRUSTED_NO_PROMOTION=19; TRUSTED_SOURCE_BUT_NO_DATA_BLOCKED=3
...
- rows_reviewed: 71
- missing_scored_rows: 49
- no_data_blocked_rows: 3
- not_trusted_rows: 19
- promoted_rows: 0
- gap_status_counts: MISSING_SCORED_ROW=49; NOT_TRUSTED_SKIPPED=19; SCORED_ROW_NO_DATA_BLOCKED=3
- next_action: Repair scoring/enrichment for trusted raw candidates; no market discussion until rows are scored and non-blocked.

## Trusted Raw Scoring Queue
- queue_rows: 49
- priority_counts: P1_TRUSTED_MISSING_SCORING=48; P2_LOW_COVERAGE_SCORING=1
- scoring_needed_counts: YES=49
- source_gap_status: MISSING_SCORED_ROW
- next_action: Use this queue as the explicit input list for a future scoring/enrichment repair stage. Do not create picks from queue rows.

## Queue-to-Enrichment Dry Run Planner
- rows_planned: 49
- dry_run_decision_counts: DRY_RUN_ONLY_NO_API_CALLS=49
- risk_label_counts: MEDIUM=48; HIGH_LOW_COVERAGE=1
- priority_counts: P1_TRUSTED_MISSING_SCORING=48; P2_LOW_COVERAGE_SCORING=1
- total_estimated_call_units: 244
