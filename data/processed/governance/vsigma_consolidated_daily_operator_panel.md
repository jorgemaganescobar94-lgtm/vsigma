# vSIGMA Consolidated Daily Operator Panel - 2026-07-13
...
## No Bet
- #1 | NO_BET | Gwangju FC vs Pohang Steelers | market=NO_CLEAR_STAT_MARKET | stake=NO_STAKE | permission=NO | conf=LOW | score=-34
- #2 | NO_BET | Ulsan Hyundai FC vs Jeonbuk Motors | market=NO_CLEAR_STAT_MARKET | stake=NO_STAKE | permission=NO | conf=LOW | score=-34
...
- source: data/processed/today/2026-07-13/vsigma_api_enriched_review_board.csv
...
### API Review Rows
- P1_MANUAL_REVIEW | Ulsan Hyundai FC vs Jeonbuk Motors | status=API_ENRICHED_REVIEW_READY | score=94 | canonical=NO_CANONICAL_BOARD_PERMISSION | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION | summary=prediction_winner=Jeonbuk Motors | pred_total_home_away=37.0/63.2 | 1x2=2.75/3.30/2.45 | ou2.5=1.95/1.83
- P1_MANUAL_REVIEW | Gwangju FC vs Pohang Steelers | status=API_ENRICHED_REVIEW_READY | score=100 | canonical=NO_CANONICAL_BOARD_PERMISSION | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION | summary=prediction_winner=Pohang Steelers | pred_total_home_away=29.2/71.0 | 1x2=5.80/3.50/1.64 | ou2.5=2.25/1.62
...
- data/processed/today/2026-07-13/official_lineup_sources.csv: rows=148
- data/processed/today/2026-07-13/vsigma_probable_lineup_consensus.csv: rows=2
- data/processed/governance/official_lineup_sources.csv: rows=148
...
- .vsigma/triggers/daily_chain_self_heal.trigger: date=2026-07-13; reason=normalize_daily_chain_self_heal_date; triggered_at=2026-07-13T11:38:56+01:00
- .vsigma/triggers/daily_decision_chain_v2.trigger: date=2026-07-13; reason=normalize_daily_decision_chain_v2_date; triggered_at=2026-07-13T11:38:56+01:00
- .vsigma/triggers/prelock_official_lineup_recheck.trigger: date=2026-07-13; reason=normalize_prelock_recheck_date; triggered_at=2026-07-13T11:38:56+01:00

## Key Files
- data/processed/today/2026-07-13/vsigma_consolidated_daily_operator_panel.md
- data/processed/today/2026-07-13/vsigma_operator_brief.md
- data/processed/today/2026-07-13/vsigma_daily_execution_board.md
- data/processed/today/2026-07-13/vsigma_prelock_live_recheck.md
- data/processed/today/2026-07-13/vsigma_live_trigger_validator.md
- data/processed/today/2026-07-13/vsigma_automation_health.md
- data/processed/today/2026-07-13/vsigma_probable_lineup_source_reliability_governor.md
...
- trigger_date_counts: 2026-07-13=2
...
- finished_rows: 2
- pending_rows: 0
- accuracy_bucket_counts: STRONG_SIGNAL_VALIDATED=2
- api_1x2_counts: HIT=2
- api_double_chance_counts: HIT=2
- api_dnb_counts: HIT=2
- over_1_5_counts: HIT=2
- over_2_5_counts: HIT=2
- under_3_5_counts: MISS=1; HIT=1
- btts_counts: HIT=1; MISS=1
- pick_permission_counts: NO_PICK_PERMISSION=2
- stake_permission_counts: NO_STAKE_PERMISSION=2
