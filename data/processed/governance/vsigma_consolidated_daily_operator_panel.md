# vSIGMA Consolidated Daily Operator Panel - 2026-08-11
...
## No Bet
- #1 | NO_BET | Vasteras SK FK vs Djurgardens IF | market=NO_CLEAR_STAT_MARKET | stake=NO_STAKE | permission=NO | conf=LOW | score=-34
...
- source: data/processed/today/2026-08-11/vsigma_api_enriched_review_board.csv
...
### API Review Rows
- P1_MANUAL_REVIEW | Vasteras SK FK vs Djurgardens IF | status=API_ENRICHED_REVIEW_READY | score=100 | canonical=NO_CANONICAL_BOARD_PERMISSION | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION | summary=prediction_winner=Djurgardens IF | pred_total_home_away=26.7/73.3 | 1x2=4.60/3.95/1.67 | ou2.5=1.55/2.45
...
- data/processed/today/2026-08-11/official_lineup_sources.csv: rows=336
- data/processed/today/2026-08-11/vsigma_probable_lineup_consensus.csv: rows=1
- data/processed/governance/official_lineup_sources.csv: rows=336
...
- .vsigma/triggers/daily_chain_self_heal.trigger: date=2026-08-11; reason=normalize_daily_chain_self_heal_date; triggered_at=2026-08-11T09:30:50+01:00
- .vsigma/triggers/daily_decision_chain_v2.trigger: date=2026-08-11; reason=normalize_daily_decision_chain_v2_date; triggered_at=2026-08-11T09:30:50+01:00
- .vsigma/triggers/prelock_official_lineup_recheck.trigger: date=2026-08-11; reason=normalize_prelock_recheck_date; triggered_at=2026-08-11T09:30:50+01:00

## Key Files
- data/processed/today/2026-08-11/vsigma_consolidated_daily_operator_panel.md
- data/processed/today/2026-08-11/vsigma_operator_brief.md
- data/processed/today/2026-08-11/vsigma_daily_execution_board.md
- data/processed/today/2026-08-11/vsigma_prelock_live_recheck.md
- data/processed/today/2026-08-11/vsigma_live_trigger_validator.md
- data/processed/today/2026-08-11/vsigma_automation_health.md
- data/processed/today/2026-08-11/vsigma_probable_lineup_source_reliability_governor.md
...
- trigger_date_counts: 2026-08-11=2
...
- api_plan_name: API-Football Free
- plan_requests_per_day: 100
- rows_reviewed: 1
- p1_rows: 1
- p2_rows: 0
...
- max_auto_units_per_day: 12
- max_auto_units_per_run: 12
...
- shadow_outcome_counts: MISS=15; HIT=3
