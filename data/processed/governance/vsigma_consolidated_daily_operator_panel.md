...
## First Read
- panel_status: NONE
- operator_detail: action=NONE; final=NO_OPERATOR_ACTION; risk=NONE; health=ATTENTION; board_rows=11
...
## No Bet
- #1 | NO_BET | Avai vs Cuiaba | market=NO_CLEAR_STAT_MARKET | stake=NO_STAKE | permission=NO | conf=LOW | score=-42
- #2 | NO_BET | CRB vs Fortaleza EC | market=NO_CLEAR_STAT_MARKET | stake=NO_STAKE | permission=NO | conf=LOW | score=-42
- #3 | NO_BET | Goias vs Operario-PR | market=NO_CLEAR_STAT_MARKET | stake=NO_STAKE | permission=NO | conf=LOW | score=-42
- #4 | NO_BET | São Bernardo vs Juventude | market=NO_CLEAR_STAT_MARKET | stake=NO_STAKE | permission=NO | conf=LOW | score=-42
- #5 | NO_BET | Džiugas Telšiai vs Suduva Marijampole | market=NO_CLEAR_STAT_MARKET | stake=NO_STAKE | permission=NO | conf=LOW | score=-42
- #6 | NO_BET | Barra vs Amazonas | market=NO_CLEAR_STAT_MARKET | stake=NO_STAKE | permission=NO | conf=LOW | score=-42
- #7 | NO_BET | Brusque vs Floresta | market=NO_CLEAR_STAT_MARKET | stake=NO_STAKE | permission=NO | conf=LOW | score=-42
- #8 | NO_BET | Caxias vs Maringá | market=NO_CLEAR_STAT_MARKET | stake=NO_STAKE | permission=NO | conf=LOW | score=-42
- #9 | NO_BET | Ferroviária vs Inter De Limeira | market=NO_CLEAR_STAT_MARKET | stake=NO_STAKE | permission=NO | conf=LOW | score=-42
- #10 | NO_BET | Ituano vs Figueirense | market=NO_CLEAR_STAT_MARKET | stake=NO_STAKE | permission=NO | conf=LOW | score=-42
- #11 | NO_BET | Maranhão vs Paysandu | market=NO_CLEAR_STAT_MARKET | stake=NO_STAKE | permission=NO | conf=LOW | score=-42

## API Coverage
- board_rows=11
- source_guard_counts: DATED_INPUT_ONLY; API_COVERAGE_GATE_V2=11
- execution_permission_counts: NO=11
- avg_coverage_score: 16.8
- forecast_warning_counts: PARTIAL_RECENT_STATS=11; SHOT_SAMPLE_WEAK=11; CORNER_SAMPLE_WEAK=11; CARD_SAMPLE_WEAK=11
- missing_data_counts: recent_stats_coverage=NONE=11; lineup_coverage=NONE=11; injuries_coverage=NONE=11; standings_coverage=NONE=11; odds_coverage=NONE=11; league_coverage=PARTIAL=7


## API-Enriched Review Board
- source: data/processed/today/2026-06-21/vsigma_api_enriched_review_board.csv
...
### API Review Rows
- P1_MANUAL_REVIEW | Brooklyn vs Tampa Bay Rowdies | status=API_ENRICHED_REVIEW_READY | score=100 | canonical=NO_CANONICAL_BOARD_PERMISSION | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION | summary=prediction_winner=Tampa Bay Rowdies | pred_total_home_away=26.3/73.8 | 1x2=4.75/3.75/1.60 | ou2.5=1.62/2.20
- P1_MANUAL_REVIEW | Hartford Athletic vs Pittsburgh Riverhounds | status=API_ENRICHED_REVIEW_READY | score=100 | canonical=NO_CANONICAL_BOARD_PERMISSION | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION | summary=prediction_winner=Pittsburgh Riverhounds | pred_total_home_away=33.7/66.3 | 1x2=2.25/3.10/3.00 | ou2.5=2.15/1.65
- P1_MANUAL_REVIEW | Sporting JAX vs Charleston Battery | status=API_ENRICHED_REVIEW_READY | score=100 | canonical=NO_CANONICAL_BOARD_PERMISSION | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION | summary=prediction_winner=Charleston Battery | pred_total_home_away=35.0/65.0 | 1x2=5.20/4.20/1.50 | ou2.5=1.53/2.38
- P1_MANUAL_REVIEW | Chattanooga Red Wolves vs Naples | status=API_ENRICHED_REVIEW_READY | score=100 | canonical=NO_CANONICAL_BOARD_PERMISSION | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION | summary=prediction_winner=Chattanooga Red Wolves | pred_total_home_away=67.8/32.2 | 1x2=1.67/3.55/4.60 | ou2.5=1.85/1.85
- P1_MANUAL_REVIEW | Greenville Triumph vs Alta | status=API_ENRICHED_REVIEW_READY | score=100 | canonical=NO_CANONICAL_BOARD_PERMISSION | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION | summary=prediction_winner=Alta | pred_total_home_away=33.8/66.2 | 1x2=1.85/3.50/3.55 | ou2.5=1.70/2.05
- P1_MANUAL_REVIEW | Richmond Kickers vs Fort Wayne | status=API_ENRICHED_REVIEW_READY | score=84 | canonical=NO_CANONICAL_BOARD_PERMISSION | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION | summary=prediction_winner=Fort Wayne | pred_total_home_away=40.3/59.8 | 1x2=2.62/3.40/2.35 | ou2.5=1.77/1.95
- P2_MANUAL_REVIEW | Buffalo vs Pittsburgh Riverhounds 2 | status=API_ENRICHED_REVIEW_READY | score=58 | canonical=NO_CANONICAL_BOARD_PERMISSION | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION | summary=prediction_winner=Buffalo | pred_total_home_away=61.2/38.8
- P2_MANUAL_REVIEW | Bigfoot vs Tacoma Stars | status=API_ENRICHED_REVIEW_READY | score=70 | canonical=NO_CANONICAL_BOARD_PERMISSION | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION | summary=prediction_winner=Tacoma Stars | pred_total_home_away=25.0/75.0
- P2_MANUAL_REVIEW | Cedar Stars Rush vs Morris Elite | status=API_ENRICHED_REVIEW_READY | score=70 | canonical=NO_CANONICAL_BOARD_PERMISSION | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION | summary=prediction_winner=Cedar Stars Rush | pred_total_home_away=76.2/23.8
- P2_MANUAL_REVIEW | Hickory vs Wake | status=API_ENRICHED_REVIEW_READY | score=70 | canonical=NO_CANONICAL_BOARD_PERMISSION | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION | summary=prediction_winner=Hickory | pred_total_home_away=68.5/31.5
...
- data/processed/today/2026-06-21/official_lineup_sources.csv: rows=50
- data/processed/today/2026-06-21/vsigma_probable_lineup_consensus.csv: rows=11
...
- .vsigma/triggers/daily_chain_self_heal.trigger: date=2026-06-21; reason=normalize_daily_chain_self_heal_date; triggered_at=2026-06-21T11:52:40+01:00
- .vsigma/triggers/daily_decision_chain_v2.trigger: date=2026-06-21; reason=normalize_daily_decision_chain_v2_date; triggered_at=2026-06-21T11:52:40+01:00
- .vsigma/triggers/prelock_official_lineup_recheck.trigger: date=2026-06-21; reason=normalize_prelock_recheck_date; triggered_at=2026-06-21T11:52:40+01:00
...
- quarantine_rows: 13
- blocked_rows: 1
- trust_status_counts: TRUSTED_RAW_SOURCE=343; QUARANTINE_REVIEW=13; REJECTED_SOURCE_BLOCK=1
...
- blocked_rows: 11
- quarantine_rows: 332
- promotion_status_counts: TRUSTED_SOURCE_BUT_NO_SCORED_ROW=332; NOT_TRUSTED_NO_PROMOTION=14; TRUSTED_SOURCE_BUT_NO_DATA_BLOCKED=11
