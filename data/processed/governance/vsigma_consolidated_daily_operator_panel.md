...
### API Review Rows
- P1_MANUAL_REVIEW | Malaga vs Las Palmas | status=API_ENRICHED_REVIEW_READY | score=97 | canonical=NO_CANONICAL_BOARD_PERMISSION | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION | summary=prediction_winner=Malaga | pred_total_home_away=64.2/36.0 | 1x2=1.94/3.35/3.95 | ou2.5=2.05/1.75
- P1_MANUAL_REVIEW | Cape Town City vs Magesi | status=API_ENRICHED_REVIEW_READY | score=100 | canonical=NO_CANONICAL_BOARD_PERMISSION | pick=NO_PICK_PERMISSION | stake=NO_STAKE_PERMISSION | summary=prediction_winner=Magesi | pred_total_home_away=33.5/67.0 | 1x2=1.96/3.10/4.20 | ou2.5=2.62/1.48
...
- candidate_rules_applied: 8
- shadow_rows: 115
- finished_shadow_rows: 100
- pending_shadow_rows: 15
- shadow_outcome_counts: HIT=67; MISS=25; PENDING_RESULT=15; VOID=8
- rule_market_counts: OVER_1_5=71; API_DNB=22; API_DOUBLE_CHANCE=22
- paper_trade_permission_counts: SHADOW_ONLY=115
- activation_permission_counts: NO_RULE_ACTIVATION_PERMISSION=115
- pick_permission_counts: NO_PICK_PERMISSION=115
- stake_permission_counts: NO_STAKE_PERMISSION=115
...
- oos_class_counts: IN_SAMPLE_BOOTSTRAP=100; PENDING_RESULT=15
- activation_permission_counts: NO_RULE_ACTIVATION_PERMISSION=115
- pick_permission_counts: NO_PICK_PERMISSION=115
- stake_permission_counts: NO_STAKE_PERMISSION=115
