...
- match_stat_forecasts | status=OK | rows=2 | date=OK | path=data/processed/today/2026-06-10/vsigma_match_stat_forecasts.csv | detail=file has rows and passed basic diagnostic checks
