# vSIGMA Daily Operator Brief - 2026-06-17
...
| Counts | active=0; live=0; closed=0; watch=0; no_bet=7 | Candidate distribution |
| Reason | no active/live/watch action; no_bet=7 | Why this action level was selected |
| Final | NO_OPERATOR_ACTION | sanity=PASS; no active/live/watch action; no_bet=7; closed=0 |
...
| Field | Value | Meaning |
|---|---|---|
| Previous | date=2026-06-17; action=UNKNOWN; risk=NONE; final=NO_OPERATOR_ACTION; active=0 | data/processed/today/2026-06-17/vsigma_operator_brief.csv |
| Current | date=2026-06-17; action=NONE; risk=NONE; final=NO_OPERATOR_ACTION; active=0 | current_build |
...
- sanity_check: PASS | no active/live/watch action; no_bet=7; closed=0
...
- DRIFT_NOTIFY_REQUIRED=true
- SANITY_CHECK=PASS
- SANITY_DETAIL=no active/live/watch action; no_bet=7; closed=0
- WINDOWS_READ=UTF8 | Get-Content data/processed/today/2026-06-17/vsigma_operator_brief.md -Encoding UTF8
...
## No Bet
- #1 | NO_BET | Gnistan vs Lahti | market=NO_CLEAR_STAT_MARKET | bucket=BLOCKED | conf=LOW | score=-42 | cancel=default no bet; low forecast confidence
- #2 | NO_BET | HJK Helsinki vs Inter Turku | market=NO_CLEAR_STAT_MARKET | bucket=BLOCKED | conf=LOW | score=-42 | cancel=default no bet; low forecast confidence
- #3 | NO_BET | Ilves vs FF Jaro | market=NO_CLEAR_STAT_MARKET | bucket=BLOCKED | conf=LOW | score=-42 | cancel=default no bet; low forecast confidence
- #4 | NO_BET | SJK vs VPS | market=NO_CLEAR_STAT_MARKET | bucket=BLOCKED | conf=LOW | score=-42 | cancel=default no bet; low forecast confidence
- #5 | NO_BET | Turku PS vs KuPS | market=NO_CLEAR_STAT_MARKET | bucket=BLOCKED | conf=LOW | score=-42 | cancel=default no bet; low forecast confidence
- #6 | NO_BET | Hegelmann Litauen vs Džiugas Telšiai | market=NO_CLEAR_STAT_MARKET | bucket=BLOCKED | conf=LOW | score=-42 | cancel=default no bet; low forecast confidence
- #7 | NO_BET | Kauno Žalgiris vs Banga | market=NO_CLEAR_STAT_MARKET | bucket=BLOCKED | conf=LOW | score=-42 | cancel=default no bet; low forecast confidence
...
- data/processed/today/2026-06-17/vsigma_issue_alert_status.md
...
### Calibration Sources
- shadow_queue: data/processed/today/2026-06-17/vsigma_calibration_shadow_patch_queue.csv
- promotion_readiness: data/processed/today/2026-06-17/vsigma_shadow_patch_promotion_readiness.csv
- learning_sanity: data/processed/today/2026-06-17/vsigma_learning_chain_output_sanity.csv
