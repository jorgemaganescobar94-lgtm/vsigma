# vSIGMA Daily Operator Brief - 2026-07-16
...
| Counts | active=0; live=0; closed=0; watch=0; no_bet=3 | Candidate distribution |
| Reason | no active/live/watch action; no_bet=3 | Why this action level was selected |
| Final | NO_OPERATOR_ACTION | sanity=PASS; no active/live/watch action; no_bet=3; closed=0 |
...
| Field | Value | Meaning |
|---|---|---|
| Previous | date=2026-07-16; action=UNKNOWN; risk=NONE; final=NO_OPERATOR_ACTION; active=0 | data/processed/today/2026-07-16/vsigma_operator_brief.csv |
| Current | date=2026-07-16; action=NONE; risk=NONE; final=NO_OPERATOR_ACTION; active=0 | current_build |
...
- watch_only: 0
- no_bet: 3
- board_decisions: NO_BET=3
- recheck_decisions: CANCELLED_NO_BET=3
- live_triggers: none
...
- DRIFT_NOTIFY_REQUIRED=true
- SANITY_CHECK=PASS
- SANITY_DETAIL=no active/live/watch action; no_bet=3; closed=0
- WINDOWS_READ=UTF8 | Get-Content data/processed/today/2026-07-16/vsigma_operator_brief.md -Encoding UTF8
...
## No Bet
- #1 | NO_BET | Malisheva vs Vllaznia Shkodër | market=NO_CLEAR_STAT_MARKET | bucket=BLOCKED | conf=LOW | score=-34 | cancel=default no bet; low forecast confidence; bad or incomplete lineups
- #2 | NO_BET | Atert Bissen vs KI Klaksvik | market=NO_CLEAR_STAT_MARKET | bucket=BLOCKED | conf=LOW | score=-34 | cancel=default no bet; low forecast confidence; bad or incomplete lineups
- #3 | NO_BET | Universitatea Craiova vs ML Vitebsk | market=NO_CLEAR_STAT_MARKET | bucket=BLOCKED | conf=LOW | score=-34 | cancel=default no bet; bad or incomplete lineups
...
## Key Files
- data/processed/today/2026-07-16/vsigma_daily_execution_board.md
- data/processed/today/2026-07-16/vsigma_prelock_live_recheck.md
- data/processed/today/2026-07-16/vsigma_live_trigger_validator.md
- data/processed/today/2026-07-16/vsigma_automation_health.md
- data/processed/today/2026-07-16/vsigma_issue_alert_status.md
...
### Calibration Sources
- shadow_queue: data/processed/today/2026-07-16/vsigma_calibration_shadow_patch_queue.csv
- promotion_readiness: data/processed/today/2026-07-16/vsigma_shadow_patch_promotion_readiness.csv
