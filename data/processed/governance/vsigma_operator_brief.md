# vSIGMA Daily Operator Brief - 2026-07-06
...
| Counts | active=0; live=0; closed=0; watch=0; no_bet=2 | Candidate distribution |
| Reason | no active/live/watch action; no_bet=2 | Why this action level was selected |
| Final | NO_OPERATOR_ACTION | sanity=PASS; no active/live/watch action; no_bet=2; closed=0 |
...
| Field | Value | Meaning |
|---|---|---|
| Previous | date=2026-07-06; action=UNKNOWN; risk=NONE; final=NO_OPERATOR_ACTION; active=0 | data/processed/today/2026-07-06/vsigma_operator_brief.csv |
| Current | date=2026-07-06; action=NONE; risk=NONE; final=NO_OPERATOR_ACTION; active=0 | current_build |
...
- sanity_check: PASS | no active/live/watch action; no_bet=2; closed=0
...
- watch_only: 0
- no_bet: 2
- board_decisions: NO_BET=2
- recheck_decisions: CANCELLED_NO_BET=2
- live_triggers: none
...
- DRIFT_NOTIFY_REQUIRED=true
- SANITY_CHECK=PASS
- SANITY_DETAIL=no active/live/watch action; no_bet=2; closed=0
- WINDOWS_READ=UTF8 | Get-Content data/processed/today/2026-07-06/vsigma_operator_brief.md -Encoding UTF8
...
## No Bet
- #1 | NO_BET | Degerfors IF vs Malmo FF | market=NO_CLEAR_STAT_MARKET | bucket=BLOCKED | conf=LOW | score=-34 | cancel=default no bet; low forecast confidence; bad or incomplete lineups
- #2 | NO_BET | Jeonbuk Motors vs Gangwon FC | market=NO_CLEAR_STAT_MARKET | bucket=BLOCKED | conf=LOW | score=-34 | cancel=default no bet; bad or incomplete lineups
...
- data/processed/today/2026-07-06/vsigma_issue_alert_status.md
...
### Calibration Sources
- shadow_queue: data/processed/today/2026-07-06/vsigma_calibration_shadow_patch_queue.csv
- promotion_readiness: data/processed/today/2026-07-06/vsigma_shadow_patch_promotion_readiness.csv
