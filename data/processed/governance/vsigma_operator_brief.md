# vSIGMA Daily Operator Brief - 2026-06-24
...
| Field | Value | Meaning |
|---|---|---|
| Previous | date=2026-06-24; action=UNKNOWN; risk=NONE; final=NO_OPERATOR_ACTION; active=0 | data/processed/today/2026-06-24/vsigma_operator_brief.csv |
| Current | date=2026-06-24; action=NONE; risk=NONE; final=NO_OPERATOR_ACTION; active=0 | current_build |
...
- WINDOWS_READ=UTF8 | Get-Content data/processed/today/2026-06-24/vsigma_operator_brief.md -Encoding UTF8
...
- data/processed/today/2026-06-24/vsigma_issue_alert_status.md
...
### Calibration Sources
- shadow_queue: data/processed/today/2026-06-24/vsigma_calibration_shadow_patch_queue.csv
- promotion_readiness: data/processed/today/2026-06-24/vsigma_shadow_patch_promotion_readiness.csv
