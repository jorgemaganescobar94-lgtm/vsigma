# vSIGMA Daily Operator Brief - 2026-06-15
...
| Field | Value | Meaning |
|---|---|---|
| Previous | date=2026-06-15; action=UNKNOWN; risk=NONE; final=NO_OPERATOR_ACTION; active=0 | data/processed/today/2026-06-15/vsigma_operator_brief.csv |
| Current | date=2026-06-15; action=NONE; risk=NONE; final=NO_OPERATOR_ACTION; active=0 | current_build |
...
- WINDOWS_READ=UTF8 | Get-Content data/processed/today/2026-06-15/vsigma_operator_brief.md -Encoding UTF8
...
## No Bet
- #1 | NO_BET | Maringá vs Maranhão | market=NO_CLEAR_STAT_MARKET | bucket=BLOCKED | conf=LOW | score=-42 | cancel=default no bet; low forecast confidence
...
- data/processed/today/2026-06-15/vsigma_issue_alert_status.md
