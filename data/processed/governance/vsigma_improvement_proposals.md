...
- P1 | PROPOSAL_ONLY | OPERATIONAL_PROPOSAL | EXPIRED_PRELOCK_CLUSTER | n=3 | auto_apply=NO | action=Review execution timing and exclude expired rows from predictive hit-rate metrics.
