# vSIGMA Improvement Proposals - 2026-07-15

## Executive Proposal Summary
- generated_at: 2026-07-16T10:30:12+01:00
- proposals generated: 14
- proposal_type_counts: DATA_QUALITY_PROPOSAL=7; MODEL_SHADOW_PROPOSAL=5; OPERATIONAL_PROPOSAL=2
- proposal_status_counts: PROPOSAL_ONLY=8; SHADOW_CANDIDATE_REQUIRED=3; MONITOR_ONLY=3
- priority_counts: P2=5; P3=5; P1=4
...
- P3 | MONITOR_ONLY | MODEL_SHADOW_PROPOSAL | SAMPLE_KEY_CLUSTER | n=2 | auto_apply=NO | action=Create a shadow-only candidate for pattern ACTIONABLE_RESULT::OVER_2_5::FAILURE_MODE_LOW_CONVERSION::CONFIRM_EDGE; do not change production until backtest/forward-test promotion gates pass.
- P3 | MONITOR_ONLY | MODEL_SHADOW_PROPOSAL | ACTIONABLE_LOSS_CLUSTER | n=1 | auto_apply=NO | action=Create a shadow-only candidate for pattern BTTS_YES; do not change production until backtest/forward-test promotion gates pass.
