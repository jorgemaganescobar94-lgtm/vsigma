...
- #6 | STAT_WATCH_ONLY | Zaragoza vs Malaga | market=OVER_1_5_SUPPORTED | stake=NO_STAKE_OR_SYMBOLIC | lineup= | min=NA | availability= | next=rerun full chain if promoted | note=stat signal lacks portfolio context
...
- #13 | NO_BET_OR_WATCH | Palmeiras vs Chapecoense-sc | market=CORNERS_OVER_8_5_REVIEW | stake=NO_STAKE_OR_SYMBOLIC | lineup= | min=NA | availability= | next=none | note=blocked by board or low confidence
