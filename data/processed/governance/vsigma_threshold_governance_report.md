...
- CLV sufficiency: INSUFFICIENT_CLV_DATA: usable=5, available_direction_rows=5; do not change thresholds from CLV yet.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| OVER_1_5 | LOW_CONVERSION | CANDIDATE_V4_O25_FIREWALL | WATCH_PATTERN |  | 9 | 77.777778 | 0.42 | 4.666667 | SAMPLE_TOO_SMALL | Only 9 settled rows; minimum threshold-review sample is 10. |
| OVER_1_5 | LOW_CONVERSION | CANDIDATE_V5_PLAYER_IMPACT | WATCH_PATTERN |  | 7 | 71.428571 | 0.07 | 1.0 | SAMPLE_TOO_SMALL | Only 7 settled rows; minimum threshold-review sample is 10. |
| OVER_1_5 | LOW_CONVERSION | CANDIDATE_V2_SCHEDULE_ANOMALY | WATCH_PATTERN |  | 6 | 66.666667 | -0.18 | -3.0 | SAMPLE_TOO_SMALL | Only 6 settled rows; minimum threshold-review sample is 10. |
| OVER_1_5 | LOW_CONVERSION | CANDIDATE_V6_API_PREDICTIONS | WATCH_PATTERN |  | 6 | 66.666667 | -0.18 | -3.0 | SAMPLE_TOO_SMALL | Only 6 settled rows; minimum threshold-review sample is 10. |
| OVER_1_5 | LOW_CONVERSION | OFFICIAL_BASELINE | WATCH_PATTERN |  | 6 | 66.666667 | -0.18 | -3.0 | SAMPLE_TOO_SMALL | Only 6 settled rows; minimum threshold-review sample is 10. |
| OVER_2_5 | LOW_CONVERSION | OFFICIAL_BASELINE | NO_DRIFT |  | 5 | 60.0 | -0.21 | -4.2 | SAMPLE_TOO_SMALL | Only 5 settled rows; minimum threshold-review sample is 10. |
| OVER_2_5 | LOW_CONVERSION | CANDIDATE_V2_SCHEDULE_ANOMALY | NO_DRIFT |  | 4 | 50.0 | -0.73 | -18.25 | SAMPLE_TOO_SMALL | Only 4 settled rows; minimum threshold-review sample is 10. |
| OVER_2_5 | LOW_CONVERSION | CANDIDATE_V5_PLAYER_IMPACT | NO_DRIFT |  | 3 | 66.666667 | 0.27 | 9.0 | SAMPLE_TOO_SMALL | Only 3 settled rows; minimum threshold-review sample is 10. |
| OVER_2_5 | LOW_CONVERSION | CANDIDATE_V7_PRICE_DISCIPLINE | NO_DRIFT |  | 3 | 66.666667 | 0.27 | 9.0 | SAMPLE_TOO_SMALL | Only 3 settled rows; minimum threshold-review sample is 10. |
...
| OVER_1_5 | LOW_CONVERSION | CANDIDATE_V7_PRICE_DISCIPLINE | WATCH_PATTERN | CLV_UNAVAILABLE | 1 |  | 0.0 | 0.0 | SAMPLE_TOO_SMALL | Fewer than 10 settled rows; collect more snapshots before changing thresholds. |
