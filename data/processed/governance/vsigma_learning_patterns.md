...
## Top Patterns
- P1 | EXPIRED_PRELOCK_CLUSTER | EXPIRED_PRELOCK | n=4 | recommendation=Review AUTO/PRELOCK timing; exclude expired rows from predictive accuracy metrics.
...
- P2 | MARKET_RISK_CLUSTER | OVER_2_5::FAILURE_MODE_LOW_CONVERSION | n=4 | recommendation=Monitor market/risk concentration; do not adjust model until losses and sample size clear promotion gates.
