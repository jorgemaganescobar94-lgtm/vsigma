...
- pattern_type_counts: MARKET_RISK_CLUSTER=5, SAMPLE_KEY_CLUSTER=5, ACTIONABLE_LOSS_CLUSTER=2, WAITING_PRELOCK_CLUSTER=1, UNRESOLVED_DOMINANCE=1, EXPIRED_PRELOCK_CLUSTER=1
- severity_counts: P2=8, P3=6, P1=1
...
- P3 | ACTIONABLE_LOSS_CLUSTER | OVER_2_5 | n=2 | recommendation=Potential model-risk pattern; keep in proposal-only state until shadow/backtest evidence exists.
...
- P3 | SAMPLE_KEY_CLUSTER | ACTIONABLE_RESULT::OVER_2_5::FAILURE_MODE_LOW_CONVERSION::REVIEW_PATTERN | n=2 | recommendation=Keep collecting evidence; repeated sample key can feed improvement proposal only after sufficient closed results.
...
- P3 | ACTIONABLE_LOSS_CLUSTER | OVER_1_5 | n=1 | recommendation=Potential model-risk pattern; keep in proposal-only state until shadow/backtest evidence exists.
