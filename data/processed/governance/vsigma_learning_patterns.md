# vSIGMA Learning Patterns - 2026-08-07
...
- severity_counts: P2=8, P3=4, P1=1
...
- P3 | SAMPLE_KEY_CLUSTER | ACTIONABLE_RESULT::OVER_2_5::FAILURE_MODE_LOW_CONVERSION::CONFIRM_EDGE | n=2 | recommendation=Keep collecting evidence; repeated sample key can feed improvement proposal only after sufficient closed results.
