...
- expired prelock rows: 17
- data blocked rows: 0
- top improvement signals: UNKNOWN=18; REVIEW_AUTO_TIMING=11; WAIT_FOR_POST_RESULTS=4

## Market Family Summary
- learning_family_counts: EXPIRED_PRELOCK=17; UNRESOLVED=8; WAITING_PRELOCK=6; NO_BET_BLOCK=2
- learning_status_counts: TIMING_REVIEW=17; COLLECT_MORE_SAMPLE=15; PROMOTION_NOT_ALLOWED=1
