# vSIGMA Autonomous Improvement Advisor - 2026-06-05
...
- HIGH | calibration/total_goals | PATCH_CANDIDATE_REVIEW | evidence=days=4; total_rows=26; avg_hit=0.288; dominant_bias=OVER_ESTIMATE; statuses=MODEL_OVER_ESTIMATING;MODEL_OVER_ESTIMATING;MODEL_OVER_ESTIMATING;MODEL_OVER_ESTIMATING | recommendation=Open manual review for metric-specific formula adjustment. No auto-apply. | safe_auto_pr=NO | auto_merge=NO
- MEDIUM | workflow_order | OPERATOR_BEFORE_HEALTH | evidence=operator brief health_status=UNKNOWN | recommendation=Schedule health monitor before operator brief. | safe_auto_pr=YES | auto_merge=NO
- MEDIUM | health | MISSING | evidence=vsigma_automation_health.md missing | recommendation=Run health monitor before issue/brief workflows. | safe_auto_pr=YES | auto_merge=NO
