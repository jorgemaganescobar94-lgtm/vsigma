# vSIGMA Dated Scored Snapshot - 2026-06-26
...
- output_path: data/processed/today/2026-06-26/matches_vsigma_scored_v3.csv
- next_action: Snapshot written for coverage diagnostics only; do not create picks. Repair enrichment/coverage.
- auto_apply: NO
- production_change: NO

## Snapshot Rows
- Novorizontino vs Vila Nova | fixture_id=1520748 | league=Serie B | priority=NO_DATA_BLOCKED | market_hint=UNDER_OR_TEAM_TOTAL_UNDER_CHECK | data_warning=OK_FULL
