# vSIGMA Decision Quality Review - 2026-05-26
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| LDU de Quito vs Always Ready | UNDER_3_5 | WAIT | OUTSIDE_PRELOCK_WINDOW | UNRESOLVED | WAIT_UNRESOLVED | NEEDS_MORE_DATA | WAIT_FOR_POST_RESULTS |
| LDU de Quito vs Always Ready | UNDER_3_5 | NO_BET | KICKOFF_ALREADY_PASSED | UNRESOLVED | EXPIRED_PRELOCK_UNRESOLVED | NEEDS_MORE_DATA | REVIEW_AUTO_TIMING |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| UNDER_3_5 | 2 | 0 | 0 | 0 | 0 | 2 | WAIT_FOR_POST_RESULTS |
